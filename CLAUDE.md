...
**Which theme goes where (decision, 2026-09-22).** The **light** theme covers the *product surfaces*: Home, the Admin panel, and the tutor and student profiles (`/tutor`, `/alumno`). The **dark** theme is for the **content**: theory, presentations, quizzes and the workshop player. The content stays dark but is being **homogenized** against the same tokens; it is not being migrated to light. New product pages are written light from the start.
