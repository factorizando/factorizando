...
export default function CelProcEucSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 280 130" width="100%" style={{ display: "block", maxHeight: 140 }}>
      {/* Procariota */}
      <rect x={20} y={36} width={96} height={58} rx={26} fill={`${a}0d`} stroke={a} strokeWidth="2" />
      ...
      {/* Eucariota */}
      <ellipse cx={216} cy={65} rx={52} ry={34} fill={`${a}0d`} stroke={a} strokeWidth="2" />
      <circle cx={214} cy={64} r={17} fill={`${bl}1f`} stroke={bl} strokeWidth="1.8" />
      <circle cx={214} cy={64} r={6} fill={a} opacity="0.5" />
      <ellipse cx={186} cy={48} rx={8} ry={4} fill={`${tema.canal(2)}33`} stroke={tema.canal(2)} strokeWidth="1.2" />
