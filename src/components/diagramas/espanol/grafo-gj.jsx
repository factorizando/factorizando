...
export default function GrafoGJSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 520 148" width="100%" style={{ display: "block" }}>
      ...
      <text x="260" y="35" fill={tema.muted} fontSize="7.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">fricativa velar sorda (la «jota»)</text>
      ...
      <text x="131" y="97" fill={az} fontSize="8" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="middle">ANTES DE CUALQUIER VOCAL</text>
      <text x="131" y="109" fill={tema.muted} fontSize="7.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">ja · je · ji · jo · ju</text>
      {jExamples.map((ex, j) => (
      ...
      <text x="389" y="97" fill={ac} fontSize="8" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="middle">SOLO ANTES DE E O I</text>
      <text x="389" y="109" fill={tema.muted} fontSize="7.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">g+e · g+i (ante a/o/u → /g/ distinto)</text>
      {gExamples.map((ex, j) => (
      ...
      <text x="260" y="146" fill={tema.muted} fontSize="7.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">gato · gol · gusto → fonema /g/, NO /x/ — ante a/o/u, g nunca suena como jota</text>
    </svg>
  );
}
