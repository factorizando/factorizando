...
export default function RazonSemejanzaSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 490 200" width="100%" style={{ maxHeight: 180, display: "block" }}>
      ...
      <line x1="10"  y1="170" x2="170" y2="170" stroke={tema.canal(1)}  strokeWidth="2.5" opacity="0.85"/>
      <line x1="273" y1="170" x2="353" y2="170" stroke={tema.canal(1)}  strokeWidth="2.5" opacity="0.85"/>
      ...
      <text x="90"  y="186" fill={tema.canal(1)}  fontSize="12" fontFamily="Georgia,serif" fontStyle="italic" textAnchor="middle">2b</text>
      ...
      <text x="313" y="186" fill={tema.canal(1)}  fontSize="12" fontFamily="Georgia,serif" fontStyle="italic" textAnchor="middle">b</text>
      ...
      <text x="1"   y="178" fill={tema.canal(1)}  fontSize="13" fontFamily="Georgia,serif" fontStyle="italic">B</text>
      ...
      <text x="261" y="182" fill={tema.canal(1)}  fontSize="13" fontFamily="Georgia,serif" fontStyle="italic">E</text>
      <text x="357" y="182" fill={tema.acento} fontSize="13" fontFamily="Georgia,serif" fontStyle="italic">F</text>

      {/* k = 2a/a = 2b/b = 2c/c = 2 */}
      <text x="213" y="97"  fill="rgba(240,236,227,0.50)" fontSize="22" fontWeight="700" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">k = 2</text>
      <text x="213" y="115" fill="rgba(240,236,227,0.22)" fontSize="10.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle" letterSpacing="0.08em">2a/a = 2b/b = 2c/c</text>
    </svg>
  );
}
