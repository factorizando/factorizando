...
export default function CohesionPanoramaSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 520 155" width="100%" style={{ display: "block" }}>
      ...
      <text x="405" y="71" fill={tema.verde} fontSize="10" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="middle" letterSpacing="0.06em">REL. ELÍPTICAS</text>
