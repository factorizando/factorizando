...
// Panel interno: cifras operativas y cola de solicitudes. Separado de Inicio
// porque Inicio puede verse frente a un cliente; aquí sí hay totales internos.
...
export default function AdminDashboard({ onNavigate }) {
  ...
  return (
    <Page
      eyebrow="Panel"
      titulo="Dashboard"
      descripcion="Cifras internas y lo que está pendiente hoy."
    >
