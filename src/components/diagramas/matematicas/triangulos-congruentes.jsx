...
export default function TriangulosCongruentesSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 420 200" width="100%" style={{ maxHeight: 200, display: "block" }}>
      ...
      <path d={arcPath(E,D,F,22)} stroke={tema.canal(1)}  strokeWidth="1.5" fill="none" opacity="0.8"/>
      ...
      <text x="2"       y={B[1]+18} fill={tema.canal(1)}  fontSize="15" fontFamily="Georgia,serif" fontStyle="italic">B</text>
      ...
      <text x={E[0]+6} y={E[1]+18} fill={tema.canal(1)}  fontSize="15" fontFamily="Georgia,serif" fontStyle="italic">E</text>
