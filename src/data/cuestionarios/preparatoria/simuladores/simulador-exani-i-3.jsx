...
export default {
  ...
  questions: [
    ...
    // Q0 — Niveles tróficos (A)
    {
      ...
      options: [
        { id: "A", text: "Productores" },
        { id: "B", text: "Consumidores primarios" },
        { id: "C", text: "Descomponedores" },
      ],
      correctAnswer: "A",
    ...
    // Q2 — Ciclo del carbono: fotosíntesis (C)
    {
      ...
      options: [
        { id: "A", text: "Respiración celular" },
        { id: "B", text: "Descomposición" },
    ...
    // Q3 — Células eucariota vs procariota (A)
    {
      ...
      options: [
        { id: "A", text: "La célula eucariota tiene núcleo delimitado por membrana; la procariota no." },
        { id: "B", text: "La célula procariota tiene mitocondrias; la eucariota no." },
        { id: "C", text: "Solo las células procariotas realizan la respiración celular." },
      ],
      correctAnswer: "A",
    ...
    // Q4 — Selección natural (B)
    {
      ...
      options: [
        { id: "A", text: "Mutan más rápidamente" },
        { id: "B", text: "Presentan variaciones ventajosas para su entorno" },
        { id: "C", text: "Son los más grandes de la población" },
      ],
      correctAnswer: "B",
    ...
    // Q5 — Cadena alimentaria: con SVG (C)
    {
      ...
      options: [
        { id: "A", text: "Productor" },
        { id: "B", text: "Consumidor secundario" },
        { id: "C", text: "Consumidor primario" },
      ],
      correctAnswer: "C",
    ...
    // Q8 — Tabla periódica: grupo 1 (C)
    {
      ...
      options: [
        { id: "A", text: "Ser gases nobles y muy poco reactivos" },
        { id: "B", text: "Tener 7 electrones de valencia y atraer electrones fácilmente" },
        { id: "C", text: "Tener 1 electrón de valencia y reaccionar fácilmente con el agua" },
      ],
      correctAnswer: "C",
    ...
    // Q9 — Energía: tipos (A)
    {
      ...
      options: [
        { id: "A", text: "Energía potencial gravitatoria" },
        { id: "B", text: "Energía cinética" },
    ...
    // Q10 — Crecimiento poblacional: curva logística (B)
    {
      ...
      options: [
        { id: "A", text: "La tasa de natalidad de la población" },
        { id: "B", text: "La capacidad de carga del ambiente" },
        { id: "C", text: "El punto de extinción de la especie" },
      ],
      correctAnswer: "B",
    ...
    // Q11 — Fotosíntesis: ecuación general (C)
    {
      ...
      options: [
        { id: "A", text: "C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O + energía" },
        { id: "B", text: "6H₂O + 6O₂ → C₆H₁₂O₆ + CO₂" },
        { id: "C", text: "6CO₂ + 6H₂O + luz → C₆H₁₂O₆ + 6O₂" },
      ],
      correctAnswer: "C",
    ...
    // Q12 — Genética: cruce Aa × Aa (A)
    {
      ...
      options: [
        { id: "A", text: "3 dominantes : 1 recesivo" },
        { id: "B", text: "1 dominante : 1 recesivo" },
        { id: "C", text: "4 dominantes : 0 recesivos" },
      ],
      correctAnswer: "A",
    ...
    // Q13 — Ciclo del nitrógeno: fijación (B)
    {
      ...
      options: [
        { id: "A", text: "Hongos descomponedores" },
        { id: "B", text: "Bacterias fijadoras de nitrógeno" },
        { id: "C", text: "Plantas con flores" },
      ],
      correctAnswer: "B",
    ...
    // Q14 — Organelo celular: mitocondria (C)
    {
      ...
      options: [
        { id: "A", text: "Sintetizar proteínas a partir del ARN mensajero" },
        { id: "B", text: "Almacenar la información genética del organismo" },
        { id: "C", text: "Producir ATP mediante la respiración celular aerobia" },
      ],
      correctAnswer: "C",
    ...
    // Q15 — Ciclo del agua (A)
    {
      ...
      options: [
        { id: "A", text: "Evaporación y evapotranspiración" },
        { id: "B", text: "Precipitación" },
        { id: "C", text: "Escorrentía" },
      ],
      correctAnswer: "A",
    ...
    // Q17 — Enlace químico: iónico vs covalente (C)
    {
      ...
      options: [
        { id: "A", text: "Enlace covalente polar" },
        { id: "B", text: "Enlace covalente no polar" },
        { id: "C", text: "Enlace iónico" },
      ],
      correctAnswer: "C",
    ...
    // Q21 — ADN: doble hélice (A)
    {
      ...
      options: [
        { id: "A", text: "Adenina con Timina, y Guanina con Citosina" },
        { id: "B", text: "Adenina con Guanina, y Timina con Uracilo" },
        { id: "C", text: "Citosina con Timina, y Adenina con Uracilo" },
      ],
      correctAnswer: "A",
    ...
    // Q22 — Célula vegetal vs animal (B)
    {
      ...
      options: [
        { id: "A", text: "Núcleo" },
        { id: "B", text: "Pared celular y cloroplastos" },
    ...
    // Q23 — Segunda ley de Mendel (C)
    {
      ...
      options: [
        { id: "A", text: "Los alelos dominantes siempre se expresan sobre los recesivos" },
        { id: "B", text: "Los alelos de un mismo gen se separan durante la meiosis" },
        { id: "C", text: "Los genes de diferentes características se heredan de manera independiente" },
      ],
      correctAnswer: "C",
    ...
    // Q25 — Tipos de reacciones químicas (B)
    {
      ...
      options: [
        { id: "A", text: "Síntesis o combinación" },
        { id: "B", text: "Descomposición" },
        { id: "C", text: "Sustitución simple" },
      ],
      correctAnswer: "B",
    ...
    // Q26 — Metales alcalinos (C)
    {
      ...
      options: [
        { id: "A", text: "Son muy duros y tienen alto punto de fusión" },
        { id: "B", text: "Son inertes y no reaccionan con ningún elemento" },
        { id: "C", text: "Son blandos, livianos y altamente reactivos con el agua" },
      ],
      correctAnswer: "C",
    ...
    // Q27 — Primera ley de termodinámica (A)
    {
      ...
      options: [
        { id: "A", text: "La energía total se conserva; no se crea ni se destruye, solo se transforma." },
        { id: "B", text: "La energía siempre fluye del cuerpo frío al caliente." },
        { id: "C", text: "La entropía de un sistema siempre disminuye con el tiempo." },
      ],
      correctAnswer: "A",
    ...
    // Q28 — Genotipo y fenotipo (B)
    {
      ...
      options: [
        { id: "A", text: "El genotipo es lo que se observa; el fenotipo es la combinación de alelos." },
        { id: "B", text: "El genotipo es la composición genética; el fenotipo es la expresión observable." },
        { id: "C", text: "Son sinónimos que describen los mismos rasgos del organismo." },
      ],
      correctAnswer: "B",
    ...
    // Q30 — Idea principal (A)
    {
      ...
      options: [
        { id: "A", text: "Los arrecifes de coral son ecosistemas muy diversos que están amenazados por el cambio climático." },
        { id: "B", text: "Los corales se alimentan de algas que les proporcionan color y nutrientes." },
        { id: "C", text: "La temperatura global ha aumentado 2°C desde la era preindustrial." },
      ],
      correctAnswer: "A",
    ...
    // Q31 — Significado de blanqueamiento coralino (B)
    {
      ...
      options: [
        { id: "A", text: "La extinción de las especies que habitan los arrecifes de coral" },
        { id: "B", text: "El proceso por el que los corales expulsan las algas que les dan color y nutrientes" },
        { id: "C", text: "La decoloración del agua marina causada por la contaminación" },
      ],
      correctAnswer: "B",
    ...
    // Q32 — Propósito del texto (C)
    {
      ...
      options: [
        { id: "A", text: "Describir el proceso de reproducción de los corales" },
        { id: "B", text: "Comparar distintos ecosistemas marinos del planeta" },
        { id: "C", text: "Informar sobre la importancia y vulnerabilidad de los arrecifes de coral" },
      ],
      correctAnswer: "C",
    ...
    // Q34 — Consecuencia implícita (B)
    {
      ...
      options: [
        { id: "A", text: "La temperatura oceánica descenderá automáticamente." },
        { id: "B", text: "Una gran proporción de las especies marinas conocidas perderían su hábitat." },
        { id: "C", text: "Los mares se volverán más claros al desaparecer las algas coloreadas." },
      ],
      correctAnswer: "B",
    ...
    // Q35 — Atmósfera del fragmento (C)
    {
      ...
      options: [
        { id: "A", text: "Alegre y esperanzadora" },
        { id: "B", text: "Tensa y violenta" },
        { id: "C", text: "Melancólica y cargada de expectativa frustrada" },
      ],
      correctAnswer: "C",
    ...
    // Q37 — Caracterización del personaje (B)
    {
      ...
      options: [
        { id: "A", text: "Es un personaje admirado y celebrado por el pueblo." },
        { id: "B", text: "Regresó frustrado o derrotado y enfrenta la mirada del pueblo con vergüenza o dolor." },
        { id: "C", text: "No le importa la opinión de sus vecinos." },
      ],
      correctAnswer: "B",
    ...
    // Q38 — Significado contextual (C)
    {
      ...
      options: [
        { id: "A", text: "Que Don Aurelio es una persona callada por naturaleza." },
        { id: "B", text: "Que Don Aurelio sufrió una pérdida auditiva en la ciudad." },
        { id: "C", text: "Un estado de tristeza o desaliento que no puede o no quiere expresar con palabras." },
      ],
      correctAnswer: "C",
    ...
    // Q39 — Tipo de narrador (A)
    {
      ...
      options: [
        { id: "A", text: "Narrador en tercera persona (omnisciente o testigo)" },
        { id: "B", text: "Narrador en primera persona protagonista" },
        { id: "C", text: "Narrador en segunda persona" },
      ],
      correctAnswer: "A",
    ...
    // Q40 — Principal efecto de la imprenta (B)
    {
      ...
      options: [
        { id: "A", text: "Eliminó la necesidad de los copistas en los monasterios." },
        { id: "B", text: "Facilitó la difusión masiva del conocimiento en Europa." },
        { id: "C", text: "Unificó los distintos idiomas europeos en uno solo." },
      ],
      correctAnswer: "B",
    ...
    // Q41 — Uso de "algunos historiadores" (C)
    {
      ...
      options: [
        { id: "A", text: "Para indicar que la imprenta no tuvo un impacto real." },
        { id: "B", text: "Para demostrar que todos los historiadores están de acuerdo con esa afirmación." },
        { id: "C", text: "Para matizar la afirmación y mostrar que es una valoración, no un hecho comprobado." },
      ],
      correctAnswer: "C",
    ...
    // Q42 — Situación previa a la imprenta (A)
    {
      ...
      options: [
        { id: "A", text: "Mediante la copia manual por parte de copistas, un proceso lento." },
        { id: "B", text: "Con máquinas de vapor que imprimían en grandes cantidades." },
        { id: "C", text: "A través de un sistema de distribución organizado por la Iglesia." },
      ],
      correctAnswer: "A",
    ...
    // Q43 — Significado de "copistas" (B)
    {
      ...
      options: [
        { id: "A", text: "Inventores de máquinas de escritura mecánica" },
        { id: "B", text: "Personas dedicadas a reproducir textos a mano" },
        { id: "C", text: "Comerciantes de libros en la Europa medieval" },
      ],
      correctAnswer: "B",
    ...
    // Q44 — Inferencia del texto (C)
    {
      ...
      options: [
        { id: "A", text: "Los cambios sociales solo dependen de factores económicos, no informativos." },
        { id: "B", text: "La imprenta fue irrelevante para los movimientos culturales europeos." },
        { id: "C", text: "Una mayor circulación de textos puede impulsar transformaciones culturales, religiosas y científicas." },
      ],
      correctAnswer: "C",
    ...
    // Q45 — Postura del autor (A)
    {
      ...
      options: [
        { id: "A", text: "Reconoce sus beneficios pero advierte sobre sus riesgos y propone una actitud crítica." },
        { id: "B", text: "Defiende el uso irrestricto de las redes sociales como herramienta educativa." },
        { id: "C", text: "Propone la prohibición total de las plataformas digitales." },
      ],
      correctAnswer: "A",
    ...
    // Q46 — Significado de "burbujas informativas" (B)
    {
      ...
      options: [
        { id: "A", text: "Noticias falsas difundidas masivamente en internet" },
        { id: "B", text: "Entornos digitales donde solo se recibe información que confirma las ideas propias" },
        { id: "C", text: "Aplicaciones de mensajería que aíslan a los usuarios del mundo real" },
      ],
      correctAnswer: "B",
    ...
    // Q47 — Estructura argumentativa (C)
    {
      ...
      options: [
        { id: "A", text: "Presenta solo datos positivos sobre las redes para luego refutarlos." },
        { id: "B", text: "Narra una experiencia personal con redes sociales." },
        { id: "C", text: "Reconoce un beneficio, expone consecuencias negativas y concluye con una propuesta." },
      ],
      correctAnswer: "C",
    ...
    // Q48 — Tema central (A)
    {
      ...
      options: [
        { id: "A", text: "Los efectos negativos del uso excesivo de redes sociales y la necesidad de un consumo crítico" },
        { id: "B", text: "Las ventajas económicas de las plataformas digitales para las empresas" },
        { id: "C", text: "La historia y evolución de las redes sociales en el siglo XXI" },
      ],
      correctAnswer: "A",
    ...
    // Q49 — Evidencia utilizada (B)
    {
      ...
      options: [
        { id: "A", text: "Anécdotas personales sobre el uso de redes sociales" },
        { id: "B", text: "Referencia a estudios psicológicos como respaldo científico" },
        { id: "C", text: "Estadísticas sobre el número de usuarios de cada plataforma" },
      ],
      correctAnswer: "B",
    ...
    // Q50 — Idea principal (C)
    {
      ...
      options: [
        { id: "A", text: "Aprender música es el único método para mejorar las capacidades mentales." },
        { id: "B", text: "El cerebro adulto es una estructura rígida que no puede modificarse." },
        { id: "C", text: "El cerebro conserva la capacidad de cambiar y formar nuevas conexiones durante toda la vida." },
      ],
      correctAnswer: "C",
    ...
    // Q51 — Cambio de perspectiva (A)
    {
      ...
      options: [
        { id: "A", text: "De considerar el cerebro adulto inmutable a reconocer su capacidad de cambio continuo." },
        { id: "B", text: "De estudiar el cerebro de adultos a centrarse solo en el cerebro infantil." },
        { id: "C", text: "De la neurología clínica hacia la psicología conductual." },
      ],
      correctAnswer: "A",
    ...
    // Q52 — Significado de "inmutable" (B)
    {
      ...
      options: [
        { id: "A", text: "Muy grande y complejo" },
        { id: "B", text: "Que no puede cambiar" },
        { id: "C", text: "Difícil de estudiar científicamente" },
      ],
      correctAnswer: "B",
    ...
    // Q53 — Propósito de los ejemplos (C)
    {
      ...
      options: [
        { id: "A", text: "Para recomendar actividades de ocio sin relación con el tema." },
        { id: "B", text: "Para demostrar que solo los músicos pueden desarrollar neuroplasticidad." },
        { id: "C", text: "Para ejemplificar con casos concretos el fenómeno de la neuroplasticidad." },
      ],
      correctAnswer: "C",
    ...
    // Q54 — Implicación práctica (A)
    {
      ...
      options: [
        { id: "A", text: "Las personas pueden continuar aprendiendo y desarrollando habilidades a cualquier edad." },
        { id: "B", text: "Solo los niños tienen capacidad real de aprendizaje gracias al cerebro plástico." },
        { id: "C", text: "La neuroplasticidad es irrelevante para el proceso educativo formal." },
      ],
      correctAnswer: "A",
    ...
    // Q56 — Significado de "estrés hídrico" (C)
    {
      ...
      options: [
        { id: "A", text: "Exceso de lluvias que provoca inundaciones masivas" },
        { id: "B", text: "Contaminación del agua dulce por actividades industriales" },
        { id: "C", text: "Situación de escasez o presión sobre los recursos de agua disponibles" },
      ],
      correctAnswer: "C",
    ...
    // Q57 — Propósito del texto (A)
    {
      ...
      options: [
        { id: "A", text: "Informar sobre la escasez y distribución desigual del agua dulce en el mundo." },
        { id: "B", text: "Promover el consumo de agua embotellada como solución al estrés hídrico." },
        { id: "C", text: "Explicar el proceso químico de purificación del agua marina." },
      ],
      correctAnswer: "A",
    ...
    // Q58 — Paradoja o contraste (B)
    {
      ...
      options: [
        { id: "A", text: "El agua es escasa en todo el planeta sin excepción." },
        { id: "B", text: "Siendo el agua renovable, su distribución desigual provoca tanto exceso como escasez según la región." },
        { id: "C", text: "Los glaciares contienen más agua que los océanos." },
      ],
      correctAnswer: "B",
    ...
    // Q59 — Conclusión inferida (C)
    {
      ...
      options: [
        { id: "A", text: "La crisis del agua ya fue resuelta gracias al ciclo hidrológico." },
        { id: "B", text: "Solo los países en desarrollo enfrentarán problemas de agua en el futuro." },
        { id: "C", text: "La gestión eficiente del agua es un desafío global urgente con implicaciones a largo plazo." },
      ],
      correctAnswer: "C",
    ...
    // Q60 — Propósito del resumen ejecutivo (A)
    {
      ...
      options: [
        { id: "A", text: "Presentar de forma condensada los resultados más relevantes de un estudio" },
        { id: "B", text: "Describir detalladamente la metodología utilizada en la investigación" },
        { id: "C", text: "Argumentar a favor de nuevas políticas de control ambiental" },
      ],
      correctAnswer: "A",
    ...
    // Q61 — Registro formal en informe académico (B)
    {
      ...
      options: [
        { id: "A", text: "Los resultados que obtuvimos fueron bastante buenos y nos pusieron muy contentos." },
        { id: "B", text: "Los resultados obtenidos demuestran una correlación positiva entre las variables estudiadas." },
        { id: "C", text: "Salió todo bien con el experimento y los datos tienen mucho sentido si los analizas." },
      ],
      correctAnswer: "B",
    ...
    // Q62 — Tipo de texto: reseña bibliográfica (C)
    {
      ...
      options: [
        { id: "A", text: "Artículo periodístico de nota informativa" },
        { id: "B", text: "Monografía de investigación histórica" },
        { id: "C", text: "Reseña bibliográfica" },
      ],
      correctAnswer: "C",
    ...
    // Q63 — Corrección gramatical: leísmo (A)
    {
      ...
      options: [
        { id: "A", text: "El director lo felicitó por su desempeño. (refiriéndose a un alumno)" },
        { id: "B", text: "El director le felicitó por su desempeño. (refiriéndose a un alumno)" },
        { id: "C", text: "El director les felicitó a ambos alumnos. (refiriéndose a dos alumnos)" },
      ],
      correctAnswer: "A",
    ...
    // Q65 — Marcador textual adversativo (C)
    {
      ...
      options: [
        { id: "A", text: "Además" },
        { id: "B", text: "Por lo tanto" },
        { id: "C", text: "Sin embargo" },
      ],
      correctAnswer: "C",
    ...
    // Q67 — Puntuación: punto y coma en enumeración compleja (B)
    {
      ...
      options: [
        { id: "A", text: "Se presentaron tres ponentes; y todos abordaron el mismo tema." },
        { id: "B", text: "La primera parte fue teórica; la segunda, práctica; y la tercera, evaluativa." },
        { id: "C", text: "El proyecto fue exitoso; gracias al esfuerzo del equipo." },
      ],
      correctAnswer: "B",
    ...
    // Q68 — Tilde diacrítica: él/el, tú/tu, más/mas (C)
    {
      ...
      options: [
        { id: "A", text: "Él no sabe si tú vendrás, más ya se lo notifiqué." },
        { id: "B", text: "El no sabe si tu vendrás, más ya se lo notifiqué." },
        { id: "C", text: "Él no sabe si tú vendrás, mas ya se lo notifiqué." },
      ],
      correctAnswer: "C",
    ...
    // Q69 — Correferencia pronominal (A)
    {
      ...
      options: [
        { id: "A", text: "La investigadora presentó sus conclusiones; ella misma respondió las preguntas." },
        { id: "B", text: "La investigadora presentó sus conclusiones; este respondió las preguntas." },
        { id: "C", text: "La investigadora presentó sus conclusiones; aquél respondió las preguntas." },
      ],
      correctAnswer: "A",
    ...
    // Q70 — Concordancia con sujeto colectivo (B)
    {
      ...
      options: [
        { id: "A", text: "La mayoría de los estudiantes aprobaron el examen." },
        { id: "B", text: "La mayoría de los estudiantes aprobó el examen." },
        { id: "C", text: "La mayoría de los estudiante aprobaron el examen." },
      ],
      correctAnswer: "B",
    ...
    // Q71 — Propósito del abstract (C)
    {
      ...
      options: [
        { id: "A", text: "Marco teórico" },
        { id: "B", text: "Conclusiones" },
        { id: "C", text: "Resumen (abstract)" },
      ],
      correctAnswer: "C",
    ...
    // Q72 — Coma antes de "pero" (A)
    {
      ...
      options: [
        { id: "A", text: "Estudié toda la noche, pero no logré aprobar el examen." },
        { id: "B", text: "Estudié toda la noche pero, no logré aprobar el examen." },
        { id: "C", text: "Estudié, toda la noche pero no logré aprobar el examen." },
      ],
      correctAnswer: "A",
    ...
    // Q73 — Marcador adversativo: no obstante (B)
    {
      ...
      options: [
        { id: "A", text: "Por consiguiente" },
        { id: "B", text: "No obstante" },
        { id: "C", text: "Asimismo" },
      ],
      correctAnswer: "B",
    ...
    // Q74 — Ortografía: imperfecto con -b- (C)
    {
      ...
      options: [
        { id: "A", text: "Ayer, el equipo rezibia instrucciones del coordinador." },
        { id: "B", text: "Ayer, el equipo recivía instrucciones del coordinador." },
        { id: "C", text: "Ayer, el equipo recibía instrucciones del coordinador." },
      ],
      correctAnswer: "C",
    ...
    // Q75 — Registro formal en carta académica (A)
    {
      ...
      options: [
        { id: "A", text: "En espera de una respuesta favorable, quedo a sus órdenes. Atentamente," },
        { id: "B", text: "Ojalá me contesten pronto. Un saludo," },
        { id: "C", text: "Espero que todo esté bien por allá. Hasta pronto," },
      ],
      correctAnswer: "A",
    ...
    // Q77 — Corrección de voz pasiva (C)
    {
      ...
      options: [
        { id: "A", text: "El informe fue redactado por los investigadores haber revisado los datos." },
        { id: "B", text: "El informe fue redactando por los investigadores tras revisar los datos." },
        { id: "C", text: "El informe fue redactado por los investigadores tras revisar los datos." },
      ],
      correctAnswer: "C",
    ...
    // Q78 — Propósito de convocatoria (A)
    {
      ...
      options: [
        { id: "A", text: "Informar y convocar a participar en un evento específico" },
        { id: "B", text: "Explicar los criterios de evaluación del concurso" },
        { id: "C", text: "Argumentar sobre la importancia de la ciencia en la educación media" },
      ],
      correctAnswer: "A",
    ...
    // Q79 — Registro en boletín informativo institucional (B)
    {
      ...
      options: [
        { id: "A", text: "¡Ojo! Las obras en la avenida principal están tardando un chorro." },
        { id: "B", text: "Las obras de mantenimiento vial en la avenida principal concluirán el próximo viernes." },
        { id: "C", text: "Ya casi terminan las obras esas de la avenida, dice que el viernes acaban." },
      ],
      correctAnswer: "B",
    ...
    // Q80 — Tipo de texto: artículo de opinión (C)
    {
      ...
      options: [
        { id: "A", text: "Nota informativa" },
        { id: "B", text: "Reporte científico" },
        { id: "C", text: "Artículo de opinión" },
      ],
      correctAnswer: "C",
    ...
    // Q81 — Concordancia de número (A)
    {
      ...
      options: [
        { id: "A", text: "Los alumnos que participaron en el torneo obtuvieron reconocimientos." },
        { id: "B", text: "Los alumnos que participó en el torneo obtuvieron reconocimientos." },
        { id: "C", text: "Los alumno que participaron en el torneo obtuvo reconocimientos." },
      ],
      correctAnswer: "A",
    ...
    // Q82 — Antonimia: aprobación (B)
    {
      ...
      options: [
        { id: "A", text: "validación" },
        { id: "B", text: "rechazo" },
        { id: "C", text: "confirmación" },
      ],
      correctAnswer: "B",
    ...
    // Q85 — Dos puntos antes de enumeración (B)
    {
      ...
      options: [
        { id: "A", text: "Traerás lo siguiente, cuaderno, lápiz y borrador." },
        { id: "B", text: "Traerás lo siguiente: cuaderno, lápiz y borrador." },
        { id: "C", text: "Traerás lo siguiente; cuaderno, lápiz y borrador." },
      ],
      correctAnswer: "B",
    ...
    // Q86 — Tilde diacrítica: más/mas (C)
    {
      ...
      options: [
        { id: "A", text: "Quiero más café, más ya no hay." },
        { id: "B", text: "Quiero mas café, mas ya no hay." },
        { id: "C", text: "Quiero más café, mas ya no hay." },
      ],
      correctAnswer: "C",
    ...
    // Q87 — Elipsis nominal (A)
    {
      ...
      options: [
        { id: "A", text: "Juan presentó su proyecto; María, el suyo." },
        { id: "B", text: "Juan presentó su proyecto; María presentó el suyo proyecto." },
        { id: "C", text: "Juan presentó su proyecto; María lo presentó también proyecto." },
      ],
      correctAnswer: "A",
    ...
    // Q88 — Registro en circular laboral (B)
    {
      ...
      options: [
        { id: "A", text: "Oigan, por favor recuerden que mañana hay junta, no falten." },
        { id: "B", text: "Se les comunica que el día de mañana se llevará a cabo una reunión de trabajo obligatoria." },
        { id: "C", text: "Hey equipo, mañana tenemos junta, así que todos presentes, ¿ok?" },
      ],
      correctAnswer: "B",
    ...
    // Q97 — Cuadrículas 4×4: mayor proporción sombreada (C)
    {
      ...
      options: [
        { id: "A", text: "Figura A (4 celdas sombreadas)" },
        { id: "B", text: "Figura B (6 celdas sombreadas)" },
        { id: "C", text: "Figura C (8 celdas sombreadas)" },
      ],
      correctAnswer: "C",
    ...
    // Q107 — Moda y mediana (B)
    {
      ...
      options: [
        { id: "A", text: "Moda = 5, mediana = 7" },
        { id: "B", text: "Moda = 7, mediana = 5" },
        { id: "C", text: "Moda = 7, mediana = 4.5" },
      ],
      correctAnswer: "B",
    ...
    // Q122 — Notación de conjuntos por comprensión (B)
    {
      ...
      options: [
        { id: "A", text: "{x | x es par y 0 < x ≤ 12}" },
        { id: "B", text: "{x | x es número par y 0 < x ≤ 10}" },
        { id: "C", text: "{x | x es impar y x < 11}" },
      ],
      correctAnswer: "B",
