...
export default function SeSombraSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 380 138" width="100%" style={{display:"block",maxHeight:138}}>
      ...
      <line x1="50"  y1="42"  x2="50"  y2="122" stroke={tema.canal(1)}  strokeWidth="2.2"/>
      ...
      <line x1="210" y1="12"  x2="210" y2="122" stroke={tema.canal(1)}  strokeWidth="2.2"/>
      ...
      <text x="40"  y="82"  fill={tema.canal(1)}  fontSize="12" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="end">4 m</text>
      ...
      <text x="200" y="67"  fill={tema.canal(1)}  fontSize="14" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="end">?</text>
