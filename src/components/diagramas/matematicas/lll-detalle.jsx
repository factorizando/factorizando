...
export default function CriterioLLLDetalleSVG({ tema }) {
  return (
    <svg viewBox="0 0 480 182" width="100%" style={{ display: "block", maxHeight: 170 }}>
      ...
      <line x1="290" y1="162" x2="405" y2="162" stroke={tema.canal(1)}  strokeWidth="2.5" opacity="0.9"/>
      ...
      <path d="M 344,157 L 344,167 M 351,157 L 351,167"             stroke={tema.canal(1)}  strokeWidth="2" fill="none"/>
      ...
      <text x="111" y="177" fill={tema.canal(1)}  fontSize="12" fontFamily="Georgia,serif" fontStyle="italic" textAnchor="middle">kb</text>
      <text x="348" y="177" fill={tema.canal(1)}  fontSize="11" fontFamily="Georgia,serif" fontStyle="italic" textAnchor="middle">b</text>
