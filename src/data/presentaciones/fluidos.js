...
export const PRESENTACION = {
  ...
  slides: [
...

    {
      id: "ej-hidrostatica",
      tipo: "criterio_detalle",
      titulo: "Ejemplo 2 · Presión hidrostática",
...

    {
      id: "ej-pascal",
      tipo: "criterio_detalle",
      titulo: "Ejemplo 3 · Prensa hidráulica",
...

    {
      id: "ej-caudal",
      tipo: "criterio_detalle",
      titulo: "Ejemplo 4 · Gasto (llenar una alberca)",
    ...
    // ── EJERCICIOS TIPO UNAM ──────────────────────────────────────────────────
    {
      id: "f1",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 1 / 18",
...

    {
      id: "f2",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 2 / 18",
...

    {
      ...
      tipo: "ejercicio",
      svgDiagram: "flu-arquimedes",
      etiqueta: "Fluidos · Ejercicio 3 / 18",
...

    {
      id: "f4",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 4 / 18",
...

    {
      id: "f5",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 5 / 18",
...

    {
      id: "f6",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 6 / 18",
...

    {
      id: "f7",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 7 / 18",
...

    {
      ...
      tipo: "ejercicio",
      svgDiagram: "flu-presion",
      etiqueta: "Fluidos · Ejercicio 8 / 18",
...

    {
      ...
      tipo: "ejercicio",
      svgDiagram: "flu-presion",
      etiqueta: "Fluidos · Ejercicio 9 / 18",
...

    {
      ...
      tipo: "ejercicio",
      svgDiagram: "flu-pascal",
      etiqueta: "Fluidos · Ejercicio 10 / 18",
...

    {
      ...
      tipo: "ejercicio",
      svgDiagram: "flu-pascal",
      etiqueta: "Fluidos · Ejercicio 11 / 18",
...

    {
      ...
      tipo: "ejercicio",
      svgDiagram: "flu-arquimedes",
      etiqueta: "Fluidos · Ejercicio 12 / 18",
...

    {
      id: "f13",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 13 / 18",
...

    {
      ...
      tipo: "ejercicio",
      svgDiagram: "flu-continuidad",
      etiqueta: "Fluidos · Ejercicio 14 / 18",
...

    {
      ...
      tipo: "ejercicio",
      svgDiagram: "flu-continuidad",
      etiqueta: "Fluidos · Ejercicio 15 / 18",
...

    {
      id: "f16",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 16 / 18",
...

    {
      id: "f17",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 17 / 18",
...

    {
      id: "f18",
      tipo: "ejercicio",
      etiqueta: "Fluidos · Ejercicio 18 / 18",
