import{a as _,r,s as d,j as t,L as S,u as C}from"./index-DxdbHAgD.js";const k={primaria:"Primaria",secundaria:"Secundaria",prepa:"Preparatoria",universidad:"Universidad"};function E(i){if(!i)return null;const o=new Date,n=new Date(i);let c=o.getFullYear()-n.getFullYear();const s=o.getMonth()-n.getMonth();return(s<0||s===0&&o.getDate()<n.getDate())&&c--,c>=0&&c<120?c:null}function P({nombre:i}){const o=C(),n=async()=>{await d.auth.signOut(),o("/login",{replace:!0})};return t.jsxs("header",{className:"tut-top",children:[t.jsxs(S,{to:"/",className:"tut-marca",children:[t.jsx("img",{src:"/factorizando/assets/marca/v-avatar.svg",alt:"",width:"30",height:"30"}),t.jsx("span",{children:"Factoℝ[i]zando"})]}),t.jsxs("div",{className:"tut-cuenta",children:[i&&t.jsx("span",{className:"tut-nombre",children:i}),t.jsx("button",{type:"button",onClick:n,className:"tut-ghost",children:"Cerrar sesión"})]})]})}function T({onClose:i,onSolicitado:o}){const[n,c]=r.useState(""),[s,N]=r.useState(""),[m,g]=r.useState(!1),[p,b]=r.useState(null),[j,u]=r.useState(""),[y,e]=r.useState(null),[l,h]=r.useState("");async function v(a){if(a?.preventDefault(),u(""),h(""),!n.trim()&&!s.trim()){u("Escribe el correo o el teléfono del alumno.");return}g(!0);const{data:f,error:x}=await d.rpc("buscar_alumno_para_tutor",{p_email:n.trim()||null,p_telefono:s.trim()||null});if(g(!1),x){u("No se pudo buscar. Intenta de nuevo.");return}b(f||[])}async function w(a){u(""),h(""),e(a.id);const{error:f}=await d.rpc("solicitar_vinculo_tutor",{p_alumno_id:a.id});if(e(null),f){u(f.message||"No se pudo solicitar el vínculo.");return}h(`Solicitud enviada a ${a.nombre} ${a.apellidos}. Debe confirmarla desde su cuenta.`),b(x=>(x||[]).map(z=>z.id===a.id?{...z,ya_vinculado:!0}:z)),o?.()}return t.jsx("div",{className:"tut-overlay",onMouseDown:a=>{a.target===a.currentTarget&&i()},children:t.jsxs("div",{className:"tut-modal",role:"dialog","aria-modal":"true",children:[t.jsxs("div",{className:"tut-modal-cab",children:[t.jsx("h2",{children:"Agregar tutorado"}),t.jsx("button",{type:"button",className:"tut-x",onClick:i,"aria-label":"Cerrar",children:"×"})]}),t.jsx("p",{className:"tut-hint",children:"Busca al alumno por su correo o su teléfono (coincidencia exacta). Si no tiene cuenta, el administrador debe vincularlo."}),t.jsxs("form",{className:"tut-buscar",onSubmit:v,children:[t.jsxs("label",{children:[t.jsx("span",{children:"Correo"}),t.jsx("input",{value:n,onChange:a=>c(a.target.value),placeholder:"alumno@correo.com",autoFocus:!0})]}),t.jsxs("label",{children:[t.jsx("span",{children:"Teléfono (10 dígitos)"}),t.jsx("input",{value:s,onChange:a=>N(a.target.value),placeholder:"2221234567",inputMode:"numeric"})]}),t.jsx("button",{type:"submit",className:"tut-btn",disabled:m,children:m?"Buscando…":"Buscar"})]}),j&&t.jsx("div",{className:"tut-alerta tut-alerta-error",children:j}),l&&t.jsx("div",{className:"tut-alerta tut-alerta-ok",children:l}),p&&t.jsx("div",{className:"tut-resultados",children:p.length===0?t.jsx("p",{className:"tut-hint",children:"Ningún alumno coincide exactamente. Verifica el dato."}):p.map(a=>t.jsxs("div",{className:"tut-resultado",children:[t.jsxs("div",{children:[t.jsxs("div",{className:"tut-card-nombre",children:[a.nombre," ",a.apellidos]}),t.jsxs("div",{className:"tut-card-meta",children:[k[a.nivel]||a.nivel,!a.tiene_cuenta&&" · sin cuenta"]})]}),a.tiene_cuenta?a.ya_vinculado?t.jsx("span",{className:"tut-nota",children:"Ya vinculado"}):t.jsx("button",{type:"button",className:"tut-btn tut-btn-sm",disabled:y===a.id,onClick:()=>w(a),children:y===a.id?"Solicitando…":"Solicitar vínculo"}):t.jsx("span",{className:"tut-nota",children:"Pídele al administrador que lo vincule"})]},a.id))})]})})}function B(){_();const[i,o]=r.useState(!0),[n,c]=r.useState(null),[s,N]=r.useState([]),[m,g]=r.useState([]),[p,b]=r.useState(null),[j,u]=r.useState(!1);async function y(){const{data:e}=await d.rpc("solicitudes_pendientes_del_tutor");g(e||[])}return r.useEffect(()=>{let e=!1;return(async()=>{const{data:{session:l}}=await d.auth.getSession();if(e)return;if(!l){o(!1);return}const{data:h}=await d.from("profiles").select("nombre, rol").eq("id",l.user.id).single();if(e)return;b(h);const{data:v}=await d.from("tutores").select("id, nombre, apellidos").eq("profile_id",l.user.id).maybeSingle();if(!e){if(c(v),v){const{data:w}=await d.from("alumno_tutor").select("alumno_id").eq("tutor_id",v.id).eq("estado","activo"),a=(w||[]).map(x=>x.alumno_id);if(a.length){const{data:x}=await d.from("alumnos").select("*").in("id",a).order("apellidos",{ascending:!0});e||N(x||[])}const{data:f}=await d.rpc("solicitudes_pendientes_del_tutor");e||g(f||[])}o(!1)}})(),()=>{e=!0}},[]),t.jsxs("div",{className:"tut-root",children:[t.jsx("style",{children:A}),t.jsx(P,{nombre:p?.nombre}),t.jsx("main",{className:"tut-main",children:i?t.jsx("p",{className:"tut-muted",children:"Cargando…"}):n?t.jsxs(t.Fragment,{children:[t.jsxs("header",{className:"tut-cab",children:[t.jsx("span",{className:"tut-eyebrow",children:"Tutor"}),t.jsxs("h1",{className:"tut-h1",children:[n.nombre," ",n.apellidos]}),t.jsx("p",{className:"tut-sub",children:s.length===0?"Todavía no tienes alumnos vinculados.":`${s.length} ${s.length===1?"alumno":"alumnos"} a tu cargo.`}),t.jsx("div",{className:"tut-cab-acciones",children:t.jsx("button",{type:"button",className:"tut-btn",onClick:()=>u(!0),children:"Agregar tutorado"})})]}),m.length>0&&t.jsxs("section",{className:"tut-pendientes",children:[t.jsx("h2",{className:"tut-h2",children:"Pendientes de confirmación"}),m.map(e=>t.jsxs("div",{className:"tut-pendiente",children:[t.jsx("span",{className:"tut-avatar",children:(e.nombre||"?").slice(0,1).toUpperCase()}),t.jsxs("div",{className:"tut-pendiente-txt",children:[t.jsxs("div",{className:"tut-card-nombre",children:[e.nombre," ",e.apellidos]}),t.jsxs("div",{className:"tut-card-meta",children:[k[e.nivel]||e.nivel," · esperando que confirme"]})]})]},e.alumno_id))]}),t.jsx("h2",{className:"tut-h2",children:"Mis tutorados"}),t.jsx("div",{className:"tut-grid",children:s.map(e=>{const l=E(e.fecha_nacimiento);return t.jsxs(S,{to:`/tutor/alumno/${e.id}`,className:"tut-card",children:[t.jsxs("div",{className:"tut-card-cab",children:[t.jsx("span",{className:"tut-avatar",children:(e.nombre||"?").slice(0,1).toUpperCase()}),t.jsxs("div",{children:[t.jsxs("div",{className:"tut-card-nombre",children:[e.nombre," ",e.apellidos]}),t.jsxs("div",{className:"tut-card-meta",children:[k[e.nivel]||e.nivel,l!=null&&` · ${l} años`]})]})]}),t.jsxs("div",{className:"tut-card-pie",children:[t.jsx("span",{children:e.email||e.telefono||"Sin contacto"}),t.jsx("span",{className:"tut-flecha","aria-hidden":"true",children:"→"})]})]},e.id)})})]}):t.jsxs("div",{className:"tut-vacio",children:[t.jsx("h1",{children:"Tu cuenta aún no está vinculada"}),t.jsxs("p",{children:["Estás dentro como ",t.jsx("strong",{children:p?.rol||"usuario"}),", pero todavía no hay una ficha de tutor asociada a tu cuenta. Pide al administrador que enlace tu registro."]})]})}),j&&t.jsx(T,{onClose:()=>u(!1),onSolicitado:y})]})}const A=`
