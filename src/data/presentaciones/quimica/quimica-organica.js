    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Simple", "C–C (saturado)", "Etano CH₃–CH₃"],
            ["Doble", "C=C (insaturado)", "Eteno CH₂=CH₂"],
            ["Triple", "C≡C (insaturado)", "Etino CH≡CH"],
            ["Tetravalencia", "4 enlaces siempre", "CH₄: carbono con 4 hidrógenos"],
          ],
        },
        {
          tipo: "par",
          ...
          asi_es: "En CH₄ el carbono se une a 4 H (4 enlaces simples)",
          asi_no: "Dibujar un carbono con 3 o 5 enlaces → siempre son 4 (tetravalente)",
        },
        {
          tipo: "trampa",
          ancho: 5,
          ...
          asi_es: "Alcano (saturado) ↔ alqueno/alquino (insaturado)",
          asi_no: "Llamar «saturado» a un compuesto con un doble enlace",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuántos enlaces covalentes forma siempre un átomo de carbono en los compuestos orgánicos?",
          opciones: ["4", "2", "6"],
          correcta: 0,
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Alcano", "simple · -ano · CₙH₂ₙ₊₂", "Etano C₂H₆"],
            ["Alqueno", "doble · -eno · CₙH₂ₙ", "Eteno C₂H₄"],
            ["Alquino", "triple · -ino · CₙH₂ₙ₋₂", "Etino C₂H₂"],
          ],
        },
        {
          tipo: "par",
          ...
          asi_es: "Propeno: prop- (3 C) + -eno (doble enlace) → C₃H₆",
          asi_no: "Llamar «propano» a un compuesto con doble enlace → el sufijo -ano es para enlaces simples",
        },
        {
          tipo: "trampa",
          ancho: 5,
          ...
          asi_es: "Butino = 4 C con triple enlace",
          asi_no: "Suponer que «buteno» tiene triple enlace → -eno es doble enlace",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "Un hidrocarburo de tres carbonos con un solo enlace doble se llama…",
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["–OH", "Alcohol", "Etanol CH₃CH₂OH"],
            ["–COOH", "Ácido carboxílico", "Ácido acético CH₃COOH"],
            ["C=O", "Aldehído / cetona", "Acetona (cetona)"],
            ["–NH₂", "Amina", "Metilamina CH₃NH₂"],
            ["–COO–", "Éster (-oato de -ilo)", "Propanoato de etilo"],
          ],
        },
        {
          tipo: "par",
          ...
          asi_es: "CH₃COOH tiene el grupo –COOH → es un ácido carboxílico (ácido acético)",
          asi_no: "Clasificar CH₃COOH como alcohol → el grupo característico es –COOH, no –OH aislado",
        },
        {
          tipo: "trampa",
          ancho: 5,
          ...
          asi_es: "Etanol (–OH) es un alcohol; ácido acético (–COOH) es un ácido",
          asi_no: "Confundir un alcohol con un ácido por ver un oxígeno e hidrógeno",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "El etanol (CH₃CH₂OH) pertenece a la familia de los…",
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Carbohidratos", "Monosacáridos (glucosa)", "Energía inmediata"],
            ["Lípidos", "Ácidos grasos + glicerol", "Reserva de energía y membranas"],
            ["Proteínas", "Aminoácidos (enlace peptídico)", "Estructura, enzimas, transporte"],
        ...
        },
        {
          ...
          asi_es: "Las proteínas son polímeros de aminoácidos unidos por enlaces peptídicos",
          asi_no: "Decir que las proteínas están hechas de nucleótidos → esos forman los ácidos nucleicos",
        },
        {
          tipo: "trampa",
          ancho: 5,
          ...
          asi_es: "Lípidos: hidrofóbicos, reserva energética y componentes de membranas",
          asi_no: "Tratar a los lípidos como cadenas de un único monómero igual que las proteínas",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es el monómero (unidad básica) de las proteínas?",
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué macromolécula almacena y transmite la información genética?",
          opciones: ["Los ácidos nucleicos (ADN y ARN)", "Los carbohidratos", "Los lípidos"],
          correcta: 0,
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Ácido carboxílico", "–COOH", "ácido propanoico"],
            ["Éster", "–COO– (R–COO–R′)", "propanoato de etilo"],
            ["Terminación del éster", "-oato de -ilo", "metanoato de metilo"],
          ],
        },
        {
          tipo: "par",
          ...
          asi_es: "Ácido propanoico (CH₃CH₂COOH) + etanol → propanoato de etilo (CH₃CH₂COOCH₂CH₃)",
          asi_no: "Confundir el éster con un ácido carboxílico → en el éster no queda el H ácido del –OH",
        },
        {
          tipo: "trampa",
          ancho: 5,
          ...
          asi_es: "Propanoato de etilo = ácido propanoico + etanol",
          asi_no: "Decir «etanoato de propilo» para CH₃CH₂COOCH₂CH₃ → invierte ácido y alcohol",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es el grupo funcional característico de un éster como el propanoato de etilo?",
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["sp³", "enlace simple", "tetraédrica (109.5°), ej. CH₄"],
            ["sp²", "doble enlace", "trigonal plana (120°), ej. eteno"],
            ["sp", "triple enlace", "lineal (180°), ej. etino"],
          ],
        },
        {
          tipo: "par",
          ...
          asi_es: "El carbono del eteno (CH₂=CH₂) tiene un doble enlace → es sp² (trigonal plana)",
          asi_no: "Asignar sp³ a un carbono con doble enlace → el doble enlace lo hace sp²",
        },
        {
          tipo: "trampa",
          ancho: 5,
          ...
          asi_es: "Triple enlace → sp (lineal)",
          asi_no: "Pensar que el triple enlace es sp³",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué hibridación tiene cada carbono del eteno (CH₂=CH₂)?",
          opciones: ["sp²", "sp³", "sp"],
          correcta: 0,
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["1. Cadena", "la más larga con el grupo principal", "fija el nombre base"],
            ["2. Numerar", "localizadores más bajos al grupo", "empieza por el extremo correcto"],
            ["3. Ramas", "sustituyentes + localizador", "en orden alfabético"],
            ["Isomería", "cis (mismo lado) / trans (opuestos)", "solo con doble enlace"],
          ],
        },
        {
          tipo: "par",
          ...
          asi_es: "CH₃CH₂CH₂–CO–CH(CH₃)–CH₃ → 2-metil-3-hexanona (cadena de 6 C, cetona en C3, metilo en C2)",
          asi_no: "Numerar desde el otro extremo y dar localizadores más altos al grupo carbonilo",
        },
        {
          tipo: "trampa",
          ancho: 5,
          ...
          asi_es: "El doble enlace del 2-penteno está en el carbono 2",
          asi_no: "Empezar siempre por la izquierda sin comparar cuál extremo da el localizador menor",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cómo se nombra la cetona CH₃CH₂CH₂–CO–CH(CH₃)–CH₃ según la IUPAC?",
      ...
      bloques: [
        {
          ...
          enunciado: "El compuesto CH₃–CH=CH–CH₂–CH₃ se nombra como…",
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          asi_es: "Sacarosa = glucosa + fructosa",
          asi_no: "Decir que la sacarosa es glucosa + galactosa → esa es la lactosa",
        },
        {
          tipo: "trampa",
          ancho: 5,
          ...
          asi_es: "Lactosa (leche) = glucosa + galactosa",
          asi_no: "Confundir la fructosa de la sacarosa con la galactosa de la lactosa",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "La unión de glucosa + fructosa forma el disacárido llamado…",
      ...
      bloques: [
        {
          ...
          items: [
            {
              titulo: "El carbono",
              texto: "tetravalente; forma cadenas y enlaces simples, dobles y triples",
            },
            {
              titulo: "Hidrocarburos",
              texto: "alcanos (-ano), alquenos (-eno), alquinos (-ino); prefijo = n.º de C",
            },
            {
              titulo: "Grupos funcionales",
              texto: "–OH alcohol, –COOH ácido, C=O aldehído/cetona, –NH₂ amina",
            },
            {
              titulo: "Macromoléculas",
              texto: "carbohidratos, lípidos, proteínas y ácidos nucleicos",
            },
            {
              titulo: "Monómeros",
              texto: "glucosa, ácidos grasos+glicerol, aminoácidos, nucleótidos",
            },
            {
              titulo: "Éster",
              texto: "R–COO–R′; terminación -oato de -ilo (propanoato de etilo)",
            },
            {
              titulo: "Hibridación",
              texto: "sp³ simple (tetraédrica), sp² doble (trigonal plana), sp triple (lineal)",
            },
            {
              titulo: "IUPAC e isomería",
              texto: "cadena principal, localizadores bajos al grupo, ramas; cis–trans en dobles enlaces",
            },
            {
              titulo: "Disacáridos",
              texto: "sacarosa = glucosa+fructosa; lactosa = glucosa+galactosa; maltosa = glucosa+glucosa",
            },
          ],
        },
      ],
