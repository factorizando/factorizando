  ...
  slides: [
      ...
      bloques: [
        ...
        },
        {
          ...
          items: [
            {
              math: "W = F\\,d",
              texto: "cuando la fuerza es paralela al desplazamiento",
            },
            {
              math: "\\theta = 90^\\circ",
              texto: "si la fuerza es perpendicular, el trabajo es cero",
            },
            {
              math: "[\\,W\\,] = \\text{J}",
              texto: "se mide en joules: 1 J = 1 N·m",
            },
          ],
        },
        {
          tipo: "nota",
          texto: "Solo hace trabajo la componente de la fuerza en la dirección del movimiento. Sostener un objeto sin moverlo, o cargarlo horizontalmente, no implica trabajo físico (W = 0).",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Una persona empuja una caja con una fuerza horizontal de 20 N y la desplaza 5 m en la misma dirección. ¿Qué trabajo realiza?",
        },
        {
          tipo: "formula",
          ancho: 12,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "Como la fuerza y el desplazamiento van en la misma dirección (θ = 0°, cos 0° = 1), basta multiplicar fuerza por distancia. El resultado está en joules.",
        },
        {
          tipo: "formula",
          math: "W = (20)(5) = 100\\ \\text{J}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "El trabajo de una fuerza es máximo cuando la fuerza y el desplazamiento son:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Una fuerza de 50 N desplaza un objeto 4 m en su misma dirección. ¿Qué trabajo realiza?",
      ...
      bloques: [
        {
          ...
          enunciado: "Caminas horizontalmente a velocidad constante cargando una maleta. ¿Qué trabajo realiza sobre la maleta la fuerza con que la sostienes?",
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es la unidad de trabajo y energía en el Sistema Internacional?",
      ...
      bloques: [
        {
          ...
          enunciado: "Se tira de un trineo con una fuerza de 10 N que forma 60° con el suelo, desplazándolo 5 m. ¿Qué trabajo se realiza? (cos 60° = 0.5)",
      ...
      bloques: [
        {
          ...
          enunciado: "Un bloque se desliza y la fricción actúa en sentido contrario a su movimiento. El trabajo que realiza la fricción es:",
      ...
      bloques: [
        {
          ...
          enunciado: "Una fuerza desplaza un objeto 6 m en su dirección y realiza 300 J de trabajo. ¿Cuánto vale la fuerza?",
      ...
      bloques: [
        {
          ...
          enunciado: "Un satélite describe una órbita circular alrededor de la Tierra. El trabajo que realiza la fuerza de gravedad sobre él es:",
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Todo cuerpo en movimiento posee energía cinética, que depende de su masa y del cuadrado de su velocidad. Por eso un pequeño aumento de velocidad la dispara.",
        },
        {
          tipo: "figura",
          ancho: 6,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "Como la velocidad está al cuadrado, si la rapidez se duplica la energía cinética se cuadruplica. Es la razón por la que un choque a alta velocidad es tan peligroso.",
        },
        {
          tipo: "formula",
          math: "v \\to 2v \\;\\Rightarrow\\; E_c \\to 4E_c",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "¿Cuál es la energía cinética de un cuerpo de 2 kg que se mueve a 3 m/s?",
        },
        {
          tipo: "formula",
          ancho: 12,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "Se sustituyen la masa y la velocidad. Cuidado: la velocidad va al cuadrado antes de multiplicar por la mitad de la masa.",
        },
        {
          tipo: "formula",
          math: "E_c = \\tfrac12 (2)(3^2) = \\tfrac12 (2)(9) = 9\\ \\text{J}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es la energía cinética de un objeto de 4 kg que se mueve a 5 m/s?",
      ...
      bloques: [
        {
          ...
          enunciado: "Si la velocidad de un objeto se duplica, su energía cinética se vuelve:",
      ...
      bloques: [
        {
          ...
          enunciado: "Según el teorema del trabajo y la energía, el trabajo neto realizado sobre un objeto es igual a:",
          opciones: [
            "Su cambio de energía cinética",
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es la energía cinética de un cuerpo de 10 kg que se mueve a 2 m/s?",
      ...
      bloques: [
        {
          ...
          enunciado: "Si la velocidad de un objeto se triplica, su energía cinética se vuelve:",
      ...
      bloques: [
        {
          ...
          enunciado: "La energía cinética de un cuerpo depende de:",
          opciones: [
            "Su masa y el cuadrado de su velocidad",
            "Solo su masa",
            "Su altura sobre el suelo",
            "Su peso y el tiempo",
          ],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "Un objeto de 2 kg tiene una energía cinética de 100 J. ¿Cuál es su velocidad?",
      ...
      bloques: [
        {
          ...
          enunciado: "Dos cuerpos se mueven con la misma velocidad, pero uno tiene el doble de masa. Su energía cinética es:",
      ...
      bloques: [
        ...
        },
        {
          ...
          items: [
            {
              math: "E_p = mgh",
              texto: "gravitatoria: depende de la altura respecto a un nivel",
            },
            {
              math: "E_p = \\tfrac12 k x^2",
              texto: "elástica: almacenada en un resorte deformado",
            },
            {
              math: "[\\,E_p\\,] = \\text{J}",
              texto: "también se mide en joules",
            },
          ],
        },
        {
          tipo: "nota",
          texto: "La energía potencial gravitatoria es la que un objeto tiene «guardada» por su posición elevada; al caer, se transforma en energía cinética.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "¿Cuánta energía potencial gravitatoria tiene un objeto de 4 kg colocado a 3 m de altura? (g = 10 m/s²)",
        },
        {
          tipo: "formula",
          ancho: 12,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "La energía potencial gravitatoria es masa por gravedad por altura. Solo se sustituyen los datos; el resultado está en joules. Esta energía se liberaría como cinética si el objeto cayera.",
        },
        {
          tipo: "formula",
          math: "E_p = (4)(10)(3) = 120\\ \\text{J}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es la energía potencial gravitatoria de un objeto de 2 kg situado a 10 m de altura? (g = 10 m/s²)",
      ...
      bloques: [
        {
          ...
          enunciado: "Si se duplica la altura a la que está un objeto, su energía potencial gravitatoria:",
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué expresión corresponde a la energía potencial elástica de un resorte?",
      ...
      bloques: [
        {
          ...
          enunciado: "Un objeto de 5 kg está a 4 m de altura. ¿Cuál es su energía potencial gravitatoria? (g = 10 m/s²)",
      ...
      bloques: [
        {
          ...
          enunciado: "Un objeto de 3 kg tiene una energía potencial de 300 J. ¿A qué altura se encuentra? (g = 10 m/s²)",
      ...
      bloques: [
        {
          ...
          enunciado: "Cuando un objeto cae libremente, su energía potencial gravitatoria se transforma principalmente en energía:",
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Sin fricción, la energía mecánica (cinética + potencial) permanece constante: lo que se pierde de una se gana en la otra. La energía solo se transforma.",
        },
        {
          tipo: "figura",
          ancho: 6,
          clave: "ene-conservacion",
        },
        {
          tipo: "formula",
          ancho: 6,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "Al caer un objeto, su altura baja (pierde Ep) y su velocidad sube (gana Ec) en la misma cantidad. Igualando Ep arriba con Ec abajo se obtiene la rapidez sin usar el tiempo.",
        },
        {
          tipo: "formula",
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Se deja caer un objeto desde una altura de 5 m. ¿Con qué velocidad llega al suelo? (g = 10 m/s², sin fricción)",
        },
        {
          tipo: "formula",
          ancho: 12,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "La masa se cancela. Toda la energía potencial de arriba se convierte en cinética abajo. Conviene este método cuando no se conoce el tiempo.",
        },
        {
          tipo: "formula",
          math: "v = \\sqrt{2(10)(5)} = \\sqrt{100} = 10\\ \\tfrac{m}{s}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "En el punto más alto de la trayectoria de un péndulo (donde se detiene un instante), su energía es:",
      ...
      bloques: [
        {
          ...
          enunciado: "Se deja caer un objeto desde 20 m. ¿Con qué velocidad llega al suelo? (g = 10 m/s², sin fricción)",
      ...
      bloques: [
        {
          ...
          enunciado: "Se deja caer un objeto desde 5 m. ¿Con qué velocidad llega al suelo? (g = 10 m/s², sin fricción)",
      ...
      bloques: [
        {
          ...
          enunciado: "Dos objetos de distinta masa se sueltan desde la misma altura sin fricción. Al llegar al suelo, sus velocidades:",
      ...
      bloques: [
        {
          ...
          enunciado: "El principio de conservación de la energía establece que la energía:",
          opciones: [
            "No se crea ni se destruye, solo se transforma",
            "Siempre aumenta",
            "Se destruye al usarse",
            "Solo existe como calor",
          ],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "En una montaña rusa sin fricción, ¿en qué punto la velocidad del carro es máxima?",
      ...
      bloques: [
        {
          ...
          enunciado: "Cuando hay fricción, parte de la energía mecánica de un cuerpo se transforma en:",
      ...
      bloques: [
        {
          ...
          enunciado: "Un objeto cae libremente sin fricción. Cuando ha descendido la mitad de su altura inicial, su energía cinética es:",
          opciones: [
      ...
      bloques: [
        ...
        },
        {
          ...
          items: [
            {
              math: "P = \\dfrac{W}{t}",
              texto: "trabajo realizado por unidad de tiempo",
            },
            {
              math: "P = F\\,v",
              texto: "también: fuerza por velocidad",
            },
            {
              math: "[\\,P\\,] = \\text{W}",
              texto: "se mide en watts: 1 W = 1 J/s",
            },
          ],
        },
        {
          tipo: "nota",
          texto: "Dos máquinas pueden hacer el mismo trabajo, pero la más potente lo hace en menos tiempo. 1 caballo de fuerza (HP) equivale a unos 746 W.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Un motor realiza 1500 J de trabajo en 5 s. ¿Cuál es su potencia?",
        },
        {
          tipo: "formula",
          ancho: 12,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "La potencia mide qué tan rápido se hace el trabajo: se divide el trabajo entre el tiempo. El resultado está en watts (1 W = 1 J/s).",
        },
        {
          tipo: "formula",
          math: "P = \\dfrac{1500}{5} = 300\\ \\text{W}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "La potencia es una magnitud que mide:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un motor realiza 1000 J de trabajo en 4 s. ¿Cuál es su potencia?",
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es la unidad de potencia en el Sistema Internacional?",
      ...
      bloques: [
        {
          ...
          enunciado: "Un auto avanza a 5 m/s mientras el motor ejerce una fuerza de 100 N. ¿Qué potencia desarrolla?",
      ...
      bloques: [
        {
          ...
          enunciado: "Una máquina de 200 W trabaja durante 10 s. ¿Cuánto trabajo realiza?",
      ...
      bloques: [
        {
          ...
          enunciado: "Dos motores realizan el mismo trabajo, pero uno tarda menos tiempo. El que tarda menos es:",
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "La cantidad de movimiento o ímpetu mide «cuánto movimiento» lleva un cuerpo. Es un vector que combina la masa y la velocidad. El impulso de una fuerza la cambia.",
        },
        {
          tipo: "formula",
          ancho: 12,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "Cuesta más detener un objeto pesado o muy veloz: tiene más ímpetu. El impulso (fuerza por tiempo) es igual al cambio de cantidad de movimiento.",
        },
        {
          tipo: "formula",
          math: "I = F\\,t = \\Delta p, \\qquad [\\,p\\,] = \\tfrac{\\text{kg}\\cdot\\text{m}}{\\text{s}}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Si no hay fuerzas externas, la cantidad de movimiento total de un sistema antes y después de un choque es la misma. Es la clave para resolver colisiones y retrocesos.",
        },
        {
          tipo: "figura",
          ancho: 6,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "En un choque elástico se conservan el ímpetu y la energía cinética; en uno inelástico solo el ímpetu (los cuerpos pueden quedar unidos). Igualando el ímpetu total se despeja la incógnita.",
        },
        {
          tipo: "formula",
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "¿Cuál es la cantidad de movimiento de un balón de 0.5 kg que se mueve a 8 m/s?",
        },
        {
          tipo: "formula",
          ancho: 12,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "El ímpetu es simplemente la masa por la velocidad. Sus unidades son kg·m/s. Es un vector que apunta en la dirección del movimiento.",
        },
        {
          tipo: "formula",
          math: "p = (0.5)(8) = 4\\ \\tfrac{\\text{kg}\\cdot\\text{m}}{\\text{s}}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Un niño de 30 kg está parado y en reposo sobre un carrito. Al saltar hacia adelante a 2 m/s, el carrito sale disparado hacia atrás a 12 m/s. ¿Cuál es la masa del carrito? (sin fricción)",
        },
        {
          tipo: "figura",
          ancho: 6,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "Al inicio todo está en reposo, así que el ímpetu total es cero. Después, el ímpetu del niño hacia adelante debe igualar al del carrito hacia atrás para que la suma siga siendo cero.",
        },
        {
          tipo: "formula",
          math: "(30)(2) = m_c (12) \\;\\Rightarrow\\; m_c = \\dfrac{60}{12} = 5\\ \\text{kg}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es la cantidad de movimiento de un objeto de 3 kg que viaja a 4 m/s?",
      ...
      bloques: [
        {
          ...
          enunciado: "¿En qué unidades se expresa la cantidad de movimiento?",
      ...
      bloques: [
        {
          ...
          enunciado: "El impulso que recibe un objeto es igual a:",
      ...
      bloques: [
        {
          ...
          enunciado: "En un choque entre dos cuerpos, si no actúan fuerzas externas, la cantidad de movimiento total del sistema:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un carrito de 2 kg que va a 3 m/s choca y queda unido a otro de 1 kg que estaba en reposo. ¿Con qué velocidad se mueven juntos?",
      ...
      bloques: [
        {
          ...
          enunciado: "En un choque perfectamente inelástico, los cuerpos después del impacto:",
          opciones: [
            "Quedan unidos y se mueven juntos",
            "Rebotan sin perder energía",
            "Se detienen siempre los dos",
            "Conservan su energía cinética total",
          ],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es la cantidad de movimiento de un balón de 0.5 kg que se mueve a 10 m/s?",
      ...
      bloques: [
        {
          ...
          enunciado: "En un choque perfectamente elástico se conservan:",
          opciones: [
            "La cantidad de movimiento y la energía cinética",
            "Solo la cantidad de movimiento",
            "Solo la energía cinética",
            "Ni el ímpetu ni la energía",
          ],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "Un airbag protege al conductor porque, al alargar el tiempo del impacto, logra que la fuerza sobre él sea:",
      ...
      bloques: [
        {
          ...
          items: [
            {
              math: "W = F d \\cos\\theta",
              texto: "trabajo: solo la fuerza en la dirección del movimiento",
            },
            {
              math: "E_c = \\tfrac12 m v^2",
              texto: "energía cinética: depende del cuadrado de la velocidad",
            },
            {
              math: "E_p = m g h",
              texto: "energía potencial gravitatoria: depende de la altura",
            },
            {
              math: "E_c + E_p = \\text{cte}",
              texto: "sin fricción, la energía mecánica se conserva",
            },
            {
              math: "P = \\tfrac{W}{t}",
              texto: "potencia: trabajo por unidad de tiempo (watts)",
            },
            {
              math: "p = m v",
              texto: "cantidad de movimiento o ímpetu (kg·m/s)",
            },
            {
              math: "p_{antes}=p_{despues}",
              texto: "se conserva en choques sin fuerzas externas",
            },
            {
              titulo: "Choques",
              texto: "elástico conserva Ec; inelástico, los cuerpos quedan unidos",
            },
          ],
        },
      ],
