  ...
  slides: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Sólido", "Forma y volumen fijos", "Hielo, madera, metal"],
            ["Líquido", "Volumen fijo, forma variable", "Agua, aceite, mercurio"],
            ["Gas", "Forma y volumen variables", "Aire, vapor de agua"],
            ["Plasma", "Gas ionizado, sin forma fija", "Sol, neón, relámpagos"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Al hervir agua, las moléculas de H₂O siguen siendo H₂O; solo cambia la separación entre ellas.",
          asi_no: "Confundir cambio de estado con reacción química: el agua que hierve no se convierte en otra sustancia.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "El agua es la sustancia más usada para ilustrar los cambios de estado porque los experimentamos en la vida diaria. Cada transición tiene un nombre específico y ocurre al absorber o liberar calor.",
        },
        {
          tipo: "figura",
          ancho: 5,
          clave: "fisica-cambios-estado",
        },
        {
          tipo: "pasos",
          ancho: 7,
          ...
          pasos: [
            {
              pre: "Fusión (S→L): ",
              math: "\\text{hielo} \\xrightarrow{+Q} \\text{agua líquida} \\quad (0\\,°C)",
            },
            {
              pre: "Solidificación (L→S): ",
              math: "\\text{agua líquida} \\xrightarrow{-Q} \\text{hielo} \\quad (0\\,°C)",
            },
            {
              pre: "Vaporización (L→G): ",
              math: "\\text{agua líquida} \\xrightarrow{+Q} \\text{vapor} \\quad (100\\,°C \\text{ a 1 atm})",
            },
            {
              pre: "Condensación (G→L): ",
              math: "\\text{vapor} \\xrightarrow{-Q} \\text{agua líquida}",
            },
            {
              pre: "Sublimación (S→G): ",
              math: "\\text{hielo seco (CO}_2\\text{)} \\xrightarrow{+Q} \\text{gas directamente}",
            },
            {
              pre: "Deposición (G→S): ",
              math: "\\text{vapor de agua} \\xrightarrow{-Q} \\text{escarcha}",
            },
          ],
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "El plasma se forma cuando se suministra tanta energía a un gas que los átomos pierden electrones, generando iones positivos y electrones libres. Aunque poco familiar en la Tierra, constituye más del 99 % de la materia visible del universo.",
        },
        {
          tipo: "pasos",
          ancho: 12,
      ...
      bloques: [
        {
          ...
          enunciado: "Una sustancia ocupa siempre el mismo volumen, pero adopta la forma del recipiente que la contiene. ¿En qué estado de la materia se encuentra?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál de los siguientes procesos es un cambio de estado y NO una reacción química?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "El 'hielo seco' es CO₂ sólido que a temperatura ambiente pasa directamente al estado gaseoso sin volverse líquido. ¿Cómo se llama este cambio de estado?",
          opciones: ["Sublimación.", "Vaporización.", "Fusión."],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "¿En cuál de los cuatro estados de la materia las partículas tienen mayor separación y menor atracción entre sí?",
          opciones: ["En el estado gaseoso.", "En el estado líquido.", "En el estado sólido."],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "Al enfriar vapor de agua por debajo de 100 °C a presión atmosférica, ¿qué cambio de estado ocurre y cómo se llama?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Estática", "Objeto en reposo", "Libro en mesa inclinada que no resbala"],
            ["Cinética", "Objeto en movimiento", "Frenos de auto al deslizarse"],
            ["Rodamiento", "Objeto rueda sobre sup.", "Llanta de bicicleta"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Un barco de acero flota porque su densidad promedio (incluido el aire interior) es menor que la del agua.",
          asi_no: "Pensar que los objetos pesados siempre se hunden: un barco de miles de toneladas flota, mientras que un tornillo de acero se hunde.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Un bloque de madera con volumen 0.0002 m³ se sumerge completamente en agua (densidad = 1000 kg/m³, g = 10 m/s²). Calcula el empuje y determina si el bloque flota o se hunde si su masa es 150 g.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "E = \\rho_{fluido}\\cdot V\\cdot g = 1000 \\times 0.0002 \\times 10 = 2\\,\\text{N}",
            },
            {
              pre: "Peso del bloque: ",
              math: "W = m\\cdot g = 0.150 \\times 10 = 1.5\\,\\text{N}",
            },
            {
              pre: "Comparación: ",
              math: "E = 2\\,\\text{N} > W = 1.5\\,\\text{N}",
            },
            {
              pre: "Conclusión: el empuje supera al peso, por lo que el bloque ",
              math: "\\textbf{flota}\\text{ (sube hasta la superficie)}",
            },
          ],
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Una caja de 10 kg descansa sobre un piso horizontal. El coeficiente de fricción estática es μ = 0.4 y g = 10 m/s². ¿Cuál es la fuerza máxima de fricción antes de que la caja empiece a moverse?",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              pre: "Fuerza normal: ",
              math: "N = m\\cdot g = 100\\,\\text{N}",
            },
            {
              pre: "Fricción estática máxima: ",
              math: "f_{e,\\text{máx}} = \\mu_e \\cdot N = 0.4 \\times 100 = 40\\,\\text{N}",
            },
            {
              pre: "Interpretación: si empujas con menos de 40 N, la caja ",
              math: "\\textbf{no se mueve}\\text{ (la fricción cancela tu fuerza)}",
            },
            {
              pre: "Si empujas con más de 40 N, la caja comienza a deslizarse; entonces actúa la ",
              math: "\\text{fricción cinética } (f_c = \\mu_c \\cdot N < f_{e,\\text{máx}})",
            },
          ],
        },
      ],
      ...
      bloques: [
        {
          ...
          enunciado: "Se coloca un cubo de madera en un recipiente con agua y el cubo flota. ¿Qué relación hay entre el peso del cubo y el empuje que recibe?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un clavo de acero se hunde en agua. ¿Cuál es la razón correcta?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un objeto está en reposo sobre una mesa horizontal. ¿Qué puede concluirse sobre las fuerzas que actúan sobre él?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un submarino puede hundirse o subir a la superficie. ¿Cuál es el mecanismo correcto?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Por qué es más fácil deslizar una caja sobre hielo que sobre asfalto, aunque tenga el mismo peso?",
          opciones: [
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ...
            ["Gráfica v-t", "Línea horizontal", "Línea diagonal"],
            ["Gráfica d-t", "Línea diagonal", "Parábola"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Un auto que da una curva puede mantener su rapidez (magnitud) constante, pero su velocidad cambia porque cambia la dirección.",
          asi_no: "Confundir 'velocidad constante' con 'rapidez constante': en movimiento circular uniforme la rapidez es constante pero la velocidad (dirección) cambia continuamente.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "En los Juegos Olímpicos de 2009, Usain Bolt corrió 100 m en 9.58 s. Calcula su velocidad promedio y compárala con la de un corredor aficionado que tarda 15 s.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "v = \\frac{d}{t} = \\frac{100}{9.58} \\approx 10.4\\,\\text{m/s} \\approx 37.6\\,\\text{km/h}",
            },
            {
              pre: "Velocidad del aficionado: ",
              math: "v = \\frac{100}{15} \\approx 6.7\\,\\text{m/s} \\approx 24.1\\,\\text{km/h}",
            },
            {
              pre: "Nota: la velocidad promedio no indica que el corredor fue siempre a esa misma rapidez; ",
              math: "\\text{al inicio acelera y a mitad de carrera alcanza su máxima rapidez}",
            },
          ],
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Una pelota se deja caer desde una altura de 20 m. Usando g = 10 m/s², calcula la velocidad en distintos momentos y la velocidad al llegar al suelo.",
        },
        {
          tipo: "figura",
          ancho: 5,
          clave: "fisica-caida-libre",
        },
        {
          tipo: "pasos",
          ancho: 7,
          ...
          pasos: [
            {
              pre: "Fórmula de velocidad en caída libre (parte del reposo, v₀=0): ",
              math: "v = g \\cdot t \\quad \\text{o bien} \\quad v = \\sqrt{2gh}",
            },
            {
              pre: "Al cabo de t = 1 s: ",
              math: "v = 10 \\times 1 = 10\\,\\text{m/s} \\quad (\\text{altura recorrida: } h = \\tfrac{1}{2}gt^2 = 5\\,\\text{m})",
            },
            {
              pre: "Al cabo de t = 2 s: ",
              math: "v = 10 \\times 2 = 20\\,\\text{m/s} \\quad (h = \\tfrac{1}{2}\\times10\\times4 = 20\\,\\text{m})",
            },
            {
              pre: "Velocidad al llegar al suelo (h = 20 m): ",
              math: "v = \\sqrt{2 \\times 10 \\times 20} = \\sqrt{400} = 20\\,\\text{m/s}",
            },
            {
              pre: "Conclusión: la aceleración es constante (g=10 m/s²), por lo que la velocidad ",
              math: "\\text{aumenta 10 m/s cada segundo (MRUA)}.",
            },
          ],
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Un auto parte del reposo y acelera uniformemente a 3 m/s² durante 8 segundos. Calcula la velocidad final y la distancia recorrida.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              pre: "Velocidad final: ",
              math: "v = v_0 + a\\cdot t = 0 + 3 \\times 8 = 24\\,\\text{m/s} \\approx 86\\,\\text{km/h}",
            },
            {
              pre: "Distancia recorrida: ",
              math: "d = v_0 t + \\tfrac{1}{2}a t^2 = 0 + \\tfrac{1}{2}\\times 3 \\times 64 = 96\\,\\text{m}",
            },
            {
              pre: "Verificación con fórmula alternativa: ",
              math: "v^2 = v_0^2 + 2ad \\;\\Rightarrow\\; 576 = 0 + 2\\times3\\times96 = 576\\,\\checkmark",
            },
          ],
        },
      ],
      ...
      bloques: [
        {
          ...
          enunciado: "Identifica el enunciado que involucra el concepto de velocidad.",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un ciclista recorre 150 m en 30 s con velocidad constante. ¿Cuál es su velocidad?",
          opciones: ["5 m/s", "4 500 m/s", "0.2 m/s"],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "Un auto viaja a 20 m/s y frena uniformemente hasta detenerse en 4 s. ¿Cuál es su aceleración?",
          opciones: ["−5 m/s² (desaceleración)", "+5 m/s² (aceleración positiva)", "−80 m/s²"],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "Una pelota cae libremente desde el reposo (g = 10 m/s²). ¿Cuál es su velocidad después de 3 segundos?",
          opciones: ["30 m/s", "15 m/s", "10 m/s"],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "En una gráfica de velocidad vs tiempo (v-t), ¿qué representa una línea horizontal?",
          opciones: [
        ...
        },
        {
          ...
          filas: [
            [
              ...
              "Rocosos, pequeños, cercanos al Sol",
            ],
            ["Jovianos (exteriores)", "Júpiter, Saturno, Urano, Neptuno", "Gaseosos o helados, muy grandes"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "El sistema solar tiene 8 planetas. Plutón fue reclasificado como planeta enano por la UAI en 2006.",
          asi_no: "Mencionar 9 planetas incluyendo a Plutón es un error frecuente desde la reclasificación de 2006.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Una persona tiene una masa de 70 kg en la Tierra (g_Tierra = 9.8 m/s²). Calcula su peso en la Luna, Marte y Júpiter usando los valores de g de cada astro.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "W = 70 \\times 9.8 = 686\\,\\text{N}",
            },
            {
              pre: "Peso en la Luna: ",
              math: "W = 70 \\times 1.6 = 112\\,\\text{N} \\approx \\tfrac{1}{6}\\text{ del peso terrestre}",
            },
            {
              pre: "Peso en Marte: ",
              math: "W = 70 \\times 3.7 = 259\\,\\text{N} \\approx 38\\%\\text{ del peso terrestre}",
            },
            {
              pre: "Peso en Júpiter: ",
              math: "W = 70 \\times 24.8 = 1736\\,\\text{N} \\approx 2.5\\times\\text{ el peso terrestre}",
            },
            {
              pre: "Clave: ",
              math: "\\text{La masa es constante; el peso cambia porque } g \\text{ cambia en cada astro}",
            },
          ],
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "La Luna orbita la Tierra en círculo casi perfecto. La gravedad de la Tierra actúa como fuerza centrípeta. Si la distancia se duplicara, ¿qué pasaría con esa fuerza gravitacional?",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "F' = G\\,\\frac{m_1 m_2}{(2r)^2} = \\frac{G\\,m_1 m_2}{4r^2} = \\frac{F}{4}",
            },
            {
              pre: "Resultado: la fuerza gravitacional se reduce a ",
              math: "\\tfrac{1}{4}\\text{ de su valor original}",
            },
            {
            ...
            {
              pre: "Regla general: ",
              math: "\\text{si } r \\times n \\Rightarrow F \\div n^2",
            },
          ],
        },
      ],
      ...
      bloques: [
        {
          ...
          enunciado: "Un astronauta pesa 780 N en la superficie de la Tierra. En la Luna, donde la gravedad es aproximadamente 1/6 de la terrestre, ¿cuánto pesará?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuántos planetas reconoce el sistema solar según la clasificación de la UAI (Unión Astronómica Internacional) vigente desde 2006?",
          opciones: ["8 planetas.", "9 planetas (incluyendo Plutón).", "7 planetas."],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué planetas se clasifican como 'terrestres' o 'rocosos'?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Si se duplica la distancia entre dos masas, ¿cómo cambia la fuerza gravitacional entre ellas?",
          opciones: ["Se reduce a la cuarta parte (1/4).", "Se reduce a la mitad.", "Se cuadruplica."],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "¿Por qué los planetas no salen disparados en línea recta aunque se desplazan a altas velocidades?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Ep (potencial grav.)", "Ep = m·g·h", "m=masa, g=9.8 m/s², h=altura"],
            ["Ec (cinética)", "Ec = ½·m·v²", "m=masa, v=velocidad"],
            ["Em (mecánica total)", "Em = Ep + Ec", "Se conserva sin fricción"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Podemos elegir cualquier nivel como h = 0; lo importante es ser consistentes en un mismo problema.",
          asi_no: "Asumir que la energía potencial siempre es cero en el suelo: el nivel de referencia es una elección del observador, no una propiedad absoluta.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Un patinador de 60 kg viaja a 4 m/s. Calcula su energía cinética. Luego calcula qué velocidad necesitaría para tener el doble de energía cinética.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "E_c = \\tfrac{1}{2}mv^2 = \\tfrac{1}{2}\\times 60\\times 16 = 480\\,\\text{J}",
            },
            {
              pre: "Para el doble de Ec: ",
              math: "E_c' = 960\\,\\text{J}",
            },
            {
              pre: "Despejando v': ",
              math: "960 = \\tfrac{1}{2}\\times60\\times v'^2 \\Rightarrow v'^2 = 32 \\Rightarrow v' = \\sqrt{32} \\approx 5.66\\,\\text{m/s}",
            },
            {
              pre: "Observación importante: ",
              math: "\\text{para duplicar la }E_c\\text{, la velocidad solo aumenta en un factor }\\sqrt{2}\\approx 1.41",
            },
          ],
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Un niño de 30 kg parte del reposo desde lo alto de un tobogán de 5 m de altura. Despreciando la fricción y usando g = 10 m/s², ¿cuál será su velocidad en la base del tobogán?",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "E_p = mgh = 30\\times10\\times5 = 1500\\,\\text{J}",
            },
            {
              pre: "En la base (h = 0) toda la Ep se convierte en Ec: ",
              math: "E_c = 1500\\,\\text{J}",
            },
            {
              pre: "Despejando la velocidad final: ",
              math: "\\tfrac{1}{2}mv^2 = 1500 \\Rightarrow v^2 = \\frac{2\\times1500}{30} = 100 \\Rightarrow v = 10\\,\\text{m/s}",
            },
            {
              pre: "Resultado: el niño llega al fondo a ",
              math: "v = 10\\,\\text{m/s} \\approx 36\\,\\text{km/h}",
            },
            {
              pre: "Nota: la velocidad no depende de la masa del niño, solo de ",
              math: "h \\text{ y } g",
            },
          ],
        },
      ...
      bloques: [
        {
          ...
          enunciado: "Una pelota cae libremente desde una altura de 5 m. Justo antes de tocar el suelo, ¿cómo se distribuye su energía mecánica?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Una piedra de 2 kg se encuentra en reposo a 10 m de altura (g = 10 m/s²). ¿Cuánta energía potencial gravitacional tiene?",
          opciones: ["200 J", "100 J", "20 J"],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "Un patinador de 60 kg viaja a 3 m/s. ¿Cuál es su energía cinética?",
          opciones: ["270 J", "180 J", "90 J"],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "¿En qué momento de su caída libre tiene una pelota la máxima energía cinética?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál de las siguientes situaciones ilustra mejor la conservación de la energía mecánica?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Conductores", "Cobre, aluminio, plata", "Cables eléctricos, electrodos"],
            ["Semiconductores", "Silicio, germanio", "Transistores, chips, diodos"],
            ["Aislantes", "Plástico, madera, vidrio", "Recubrimiento de cables, enchufes"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Es el agua con iones disueltos (sales, minerales) la que conduce electricidad. El agua destilada es prácticamente un aislante.",
          asi_no: "Pensar que toda el agua conduce por igual: la conductividad depende de los iones presentes, no del agua en sí.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Un foco está conectado a 120 V (voltaje de la red doméstica en México). Si tiene una resistencia de 240 Ω, ¿qué corriente pasa por él? Luego, ¿cuántos ohmios necesita una resistencia para que pase 0.5 A con 12 V?",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              pre: "Ley de Ohm: ",
              math: "V = I \\cdot R \\quad \\Rightarrow \\quad I = \\frac{V}{R} \\quad \\Rightarrow \\quad R = \\frac{V}{I}",
            },
            {
              pre: "Caso 1 — corriente del foco: ",
              math: "I = \\frac{120}{240} = 0.5\\,\\text{A}",
            },
            {
              pre: "Caso 2 — resistencia necesaria: ",
              math: "R = \\frac{V}{I} = \\frac{12}{0.5} = 24\\,\\Omega",
            },
            {
              pre: "Truco del triángulo: cubre la variable que buscas; las otras dos te dan la operación ",
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Tienes tres resistencias idénticas de 60 Ω. Calcula la resistencia total si se conectan en serie y si se conectan en paralelo.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "R_{\\text{total}} = R_1 + R_2 + R_3 = 60 + 60 + 60 = 180\\,\\Omega",
            },
            {
              pre: "En paralelo — inversos: ",
              math: "\\frac{1}{R_{\\text{total}}} = \\frac{1}{60}+\\frac{1}{60}+\\frac{1}{60} = \\frac{3}{60} = \\frac{1}{20}",
            },
            {
              pre: "Por lo tanto: ",
              math: "R_{\\text{total (paralelo)}} = 20\\,\\Omega",
            },
            {
              pre: "Conclusión: la serie AUMENTA la resistencia total; el paralelo la ",
              math: "\\textbf{disminuye}\\text{ (facilita el paso de corriente)}",
            },
            {
      ...
      bloques: [
        {
          ...
          enunciado: "En un circuito en serie con tres focos, si uno de los focos se funde, ¿qué ocurre con los otros dos?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "En un circuito, el voltaje es 12 V y la resistencia es 4 Ω. ¿Cuál es la corriente?",
          opciones: ["3 A", "48 A", "0.33 A"],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál de los siguientes materiales es aislante eléctrico?",
          opciones: ["Plástico.", "Cobre.", "Aluminio."],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "En un circuito en paralelo con dos focos idénticos, si uno de ellos se funde, ¿qué ocurre con el otro?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Por qué el agua del mar conduce electricidad, pero el agua destilada prácticamente no?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Planta eléctrica", "Química (combustible)", "Eléctrica (+ calor)"],
            ["Foco incandescente", "Eléctrica", "Luminosa + térmica"],
            ["Motor de automóvil", "Química (gasolina)", "Cinética + térmica"],
            ["Panel solar", "Luminosa (sol)", "Eléctrica"],
            ["Micrófono", "Sonora (voz)", "Eléctrica"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Cuando un motor 'desperdicia' energía, la convierte en calor: el total (útil + calor) siempre se conserva.",
          asi_no: "Creer que la energía desaparece: en realidad se transforma en formas menos útiles (especialmente calor), pero el total del sistema permanece igual.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Una lámpara incandescente de 60 W solo convierte el 5% de la energía eléctrica en luz. Una lámpara LED equivalente consume 9 W y convierte el 80% en luz. Compara la potencia luminosa y el calor generado por cada una.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "P_{\\text{luz}} = 0.05 \\times 60 = 3\\,\\text{W}",
            },
            {
              pre: "Calor generado incandescente: ",
              math: "P_{\\text{calor}} = 0.95 \\times 60 = 57\\,\\text{W}",
            },
            {
              pre: "Potencia luminosa LED: ",
              math: "P_{\\text{luz}} = 0.80 \\times 9 = 7.2\\,\\text{W}",
            },
            {
              pre: "Calor generado LED: ",
              math: "P_{\\text{calor}} = 0.20 \\times 9 = 1.8\\,\\text{W}",
            },
            {
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Un automóvil eléctrico usa paneles solares para cargar su batería, que luego mueve un motor eléctrico. Identifica cada transformación de energía en la cadena y señala dónde se producen pérdidas.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            ...
            {
              pre: "Eficiencia total aproximada: ",
              math: "\\eta_{\\text{total}} = 0.20 \\times 0.95 \\times 0.90 \\approx 17\\%",
            },
            {
      ...
      bloques: [
        {
          ...
          enunciado: "Al encender una lámpara incandescente, la mayor parte de la energía eléctrica se transforma en luz. ¿Es correcta esta afirmación?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Al cargar un teléfono celular, la energía eléctrica se convierte principalmente en:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Una planta termoeléctrica de carbón convierte energía química en eléctrica con una eficiencia del 35%. ¿Qué ocurre con el 65% restante?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un motor eléctrico transforma principalmente:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál de las siguientes fuentes de energía se considera renovable?",
          opciones: [
