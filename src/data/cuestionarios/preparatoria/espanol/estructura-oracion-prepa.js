...
export default {
  ...
  questions: [
    ...
    {
      question:
        "¿Qué tipo de sujeto tiene la oración: *«¡Callemos y escuchemos con atención!»*?",
      options: ["Tácito (nosotros)", "Simple", "Compuesto", "No tiene sujeto"],
      correctAnswer: 0,
      explanation:
        "Las formas imperativas «callemos» y «escuchemos» corresponden a «nosotros», sujeto omitido que se recupera morfológicamente.",
    },
    // 75
    {
      question:
