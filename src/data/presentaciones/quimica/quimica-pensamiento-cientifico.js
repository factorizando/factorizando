  ...
  slides: [
    ...
    },
    {
      ...
      bloques: [
        ...
        {
          tipo: "figura",
          clave: "quimica-modelos-atomicos",
        ...
        },
        {
          ...
          filas: [
            ["Iónico", "Transferencia de electrones (metal + no metal)", "NaCl, MgO, CaCl₂"],
            ["Covalente", "Compartición de electrones (no metales)", "H₂O, CO₂, CH₄"],
            ["Metálico", "Mar de electrones libres (metales)", "Fe, Cu, Au, acero"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "El modelo cuántico describe regiones de probabilidad (orbitales) donde es más probable encontrar el electrón, no trayectorias fijas.",
          asi_no: "Imaginar los electrones como planetas con rutas circulares definidas: eso es el modelo de Bohr (1913), útil para hidrógeno pero incompleto para átomos multielectrónicos.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Rutherford disparó partículas alfa (α, carga positiva) contra una lámina de oro muy delgada. Según el modelo de Thomson, TODAS debían pasar casi sin desviarse. Los resultados sorprendieron a la ciencia.",
        },
        {
          tipo: "pasos",
          ancho: 12,
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Compara la formación del enlace en la sal de mesa y en el agua. Ambas son moléculas cotidianas pero sus átomos se unen de maneras completamente distintas.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            ...
            {
              pre: "Regla general: ",
              math: "\\text{metal + no metal} \\to \\text{iónico} \\qquad \\text{no metal + no metal} \\to \\text{covalente}",
            },
          ],
        },
      ],
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál modelo atómico introdujo el concepto de núcleo central cargado positivamente con electrones orbitando a su alrededor?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál modelo atómico propuso que los electrones están incrustados en una esfera de carga positiva, como 'pasas en un pudín'?",
          opciones: ["Modelo de Rutherford.", "Modelo de Thomson.", "Modelo de Bohr."],
          correcta: 1,
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué tipo de enlace se forma entre el sodio (Na) y el cloro (Cl) en la sal de mesa (NaCl)?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Dos átomos de nitrógeno (N₂) se unen compartiendo tres pares de electrones. ¿Qué tipo de enlace forman?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué partícula del átomo determina a qué elemento químico pertenece?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Carbohidratos", "Energía rápida (glucosa → ATP)", "Pan, arroz, fruta, azúcar"],
            ["Lípidos", "Reserva energética, membranas, hormonas", "Aceite, mantequilla, aguacate"],
            ["Proteínas", "Estructura, enzimas, anticuerpos", "Carne, huevo, leche, leguminosas"],
            ["Ác. nucleicos", "Información genética (ADN) y síntesis (ARN)", "Formadas en el organismo"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Los lípidos forman las membranas celulares, son precursores de hormonas y permiten absorber vitaminas A, D, E y K. Las grasas insaturadas (omega-3) son esenciales.",
          asi_no: "Creer que todos los lípidos son perjudiciales: el problema es el exceso de grasas saturadas y trans, no los lípidos en general.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Una porción de comida contiene 60 g de carbohidratos, 25 g de proteínas y 15 g de lípidos. Calcula el aporte calórico total y el porcentaje de cada macronutriente.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "60 \\times 4 = 240\\,\\text{kcal}",
            },
            {
              pre: "Calorías de proteínas: ",
              math: "25 \\times 4 = 100\\,\\text{kcal}",
            },
            {
              pre: "Calorías de lípidos: ",
              math: "15 \\times 9 = 135\\,\\text{kcal}",
            },
            {
              pre: "Total: ",
              math: "240 + 100 + 135 = 475\\,\\text{kcal}",
            },
            {
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Las células queman glucosa en la respiración aeróbica para producir ATP, la 'moneda energética' de la vida. Analiza la ecuación y comprende qué pasa con la energía.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            ...
            {
              pre: "La respiración celular ocurre en tres etapas: ",
              math: "\\text{Glucólisis (citoplasma)} \\to \\text{Ciclo de Krebs (mitocondria)} \\to \\text{Cadena respiratoria (mitocondria)}",
            },
            {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál biomolécula representa la principal fuente de energía inmediata para las células del cuerpo humano?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál biomolécula forma la membrana plasmática de todas las células?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un atleta consume 50 g de carbohidratos, 30 g de proteínas y 20 g de lípidos. ¿Cuántas kcal obtiene en total?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Los ácidos nucleicos (ADN y ARN) tienen como función principal:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Una persona consume 200 kcal caminando a paso normal gasta ~4 kcal por minuto. ¿Cuántos minutos necesita para gastar esas calorías?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Elemento", "Un solo tipo de átomo", "O₂, Fe, Au, N₂"],
            ["Compuesto", "Átomos en proporción fija", "H₂O, CO₂, NaCl"],
            ["Mezcla homogénea", "Composición uniforme (solución)", "Aire, sal+agua, vinagre"],
            ["Mezcla heterogénea", "Fases o componentes visibles", "Agua+aceite, granito, sangre"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "La sal disuelta en agua sigue siendo NaCl y H₂O: no hay reacción química. Se puede recuperar la sal por evaporación.",
          asi_no: "Confundir solución con compuesto: en un compuesto las sustancias se unen químicamente formando algo nuevo; en una solución solo se mezclan físicamente.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Identifica si cada caso es un elemento, compuesto, mezcla homogénea o heterogénea. Justifica con la característica definitoria de cada categoría.",
        },
        {
          tipo: "pasos",
          ancho: 12,
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "El suero fisiológico contiene 9 g de NaCl disueltos en 1 L de agua. Esta concentración es isotónica con la sangre humana. Calcula la concentración y entiende qué significa.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "C = \\frac{\\text{masa soluto}}{\\text{volumen solución}} \\times 100 = \\frac{9\\,\\text{g}}{1000\\,\\text{mL}} \\times 100 = 0.9\\%\\text{ (m/v)}",
            },
            {
            ...
            {
              pre: "Regla práctica: ",
              math: "\\text{solución isotónica} \\approx 0.9\\%\\text{ NaCl} \\leftrightarrow \\text{plasma sanguíneo}",
            },
          ],
        },
      ],
      ...
      bloques: [
        {
          ...
          enunciado: "Se disuelve sal en agua hasta que no se puede ver la sal. ¿Qué tipo de mezcla se forma?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "El bronce es una aleación de cobre y estaño en proporciones variables según el uso. ¿Cómo se clasifica?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "La vinagreta (aceite + vinagre) se agita y después de un momento las fases se separan. ¿Qué tipo de mezcla es?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué diferencia a un elemento de un compuesto?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Filtración", "Tamaño de partícula", "Café, purificación de agua"],
            ["Destilación", "Punto de ebullición", "Agua + alcohol, petróleo"],
            ["Cromatografía", "Afinidad química", "Pigmentos, fármacos, ADN"],
            ["Centrifugación", "Densidad", "Análisis de sangre, leche"],
            ["Decantación", "Densidad (fases líquidas)", "Aceite + agua"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Para separar sal del agua (solución), se usa evaporación o destilación, ya que los iones de sal pasan a través del filtro junto con el agua.",
          asi_no: "Intentar filtrar sal del agua: como la sal está disuelta (iones dispersos), atraviesa cualquier filtro convencional.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "El petróleo crudo es una mezcla de cientos de hidrocarburos. En las refinerías se separa por destilación fraccionada: la mezcla se calienta y cada componente se evapora a distinta temperatura.",
        },
        {
          tipo: "pasos",
          ancho: 12,
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Una tinta negra parece un solo color, pero en realidad es mezcla de varios pigmentos. La cromatografía los separa porque cada pigmento tiene distinta afinidad por el papel (fase estacionaria) y por el solvente (fase móvil).",
        },
        {
          tipo: "pasos",
          ancho: 12,
      ...
      bloques: [
        {
          ...
          enunciado: "Para obtener el agua pura a partir de una mezcla de agua y arena, el método más adecuado es:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué método se usa para separar el agua del alcohol etílico en la producción de bebidas destiladas?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "En un laboratorio forense se analizan los pigmentos de una tinta para identificar el bolígrafo usado en un documento. ¿Qué método es más adecuado?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Para separar aceite de agua después de un derrame, ¿qué método es más apropiado como primer paso?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Por qué NO se puede separar agua salada con un filtro de papel?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Físico", "No se forman nuevas sustancias", "Fundir hielo, cortar papel, disolver sal"],
            ["Químico", "Se forman sustancias nuevas", "Quemar madera, oxidar hierro, cocinar"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Disolver sal en agua es cambio físico: las moléculas de NaCl se dispersan pero no se transforman en otra sustancia.",
          asi_no: "Confundir disolución con reacción: que algo 'desaparezca' al disolverse no significa que reaccionó. Se puede recuperar la sal evaporando el agua.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "La ley de Lavoisier dice que los átomos no se crean ni se destruyen en una reacción: deben estar en igual número a ambos lados. Balancea la ecuación H₂ + O₂ → H₂O.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "2\\,\\text{H} \\;(\\text{de H}_2) \\quad 2\\,\\text{O}\\;(\\text{de O}_2)",
            },
            {
              pre: "Cuenta átomos en productos: ",
              math: "2\\,\\text{H} \\quad 1\\,\\text{O} \\;(\\text{en H}_2\\text{O})",
            },
            {
              pre: "El oxígeno no está balanceado: hay 2 O en reactivos y 1 en productos. Coloca 2 delante del H₂O: ",
              math: "\\text{H}_2 + \\text{O}_2 \\to 2\\,\\text{H}_2\\text{O}",
            },
            {
              pre: "Ahora el H no balancea: hay 2 H en reactivos y 4 en productos. Coloca 2 delante de H₂: ",
              math: "2\\,\\text{H}_2 + \\text{O}_2 \\longrightarrow 2\\,\\text{H}_2\\text{O}",
            },
            {
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Al encender el gas de la estufa (propano, C₃H₈), ocurre una combustión completa con oxígeno, produciendo dióxido de carbono y agua. Identifica reactivos, productos y tipo de reacción.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            {
              ...
              math: "\\text{C}_3\\text{H}_8 + \\text{O}_2 \\to 3\\,\\text{CO}_2 + \\text{H}_2\\text{O}",
            },
            {
              pre: "Balancea el H: hay 8 H en C₃H₈ → necesitas 4 H₂O: ",
              math: "\\text{C}_3\\text{H}_8 + \\text{O}_2 \\to 3\\,\\text{CO}_2 + 4\\,\\text{H}_2\\text{O}",
            },
            {
              pre: "Balancea el O: en productos hay 3×2 + 4×1 = 10 O → necesitas 5 O₂: ",
              math: "\\text{C}_3\\text{H}_8 + 5\\,\\text{O}_2 \\longrightarrow 3\\,\\text{CO}_2 + 4\\,\\text{H}_2\\text{O}",
            },
            {
      ...
      bloques: [
        {
          ...
          enunciado: "Al calentar hierro con azufre se forma sulfuro de hierro (FeS), una sustancia con propiedades completamente diferentes. ¿Qué tipo de cambio ocurrió?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál de los siguientes es evidencia de que ocurrió una reacción química?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "En la reacción balanceada: 2H₂ + O₂ → 2H₂O, ¿cuántos átomos de hidrógeno hay en los reactivos?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Según la ley de Lavoisier, si 4 g de hidrógeno reaccionan con 32 g de oxígeno para formar agua, ¿cuántos gramos de agua se producen?",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        {
          tipo: "figura",
          clave: "quimica-energia-reacciones",
        ...
        },
        {
          ...
          filas: [
            ["Carbohidratos", "4 kcal/g", "Energía inmediata (glucosa → ATP)"],
            ["Proteínas", "4 kcal/g", "Energía de reserva (secundario)"],
            ["Lípidos", "9 kcal/g", "Reserva energética a largo plazo"],
            ["Alcohol", "7 kcal/g", "Solo energía, sin valor nutricional"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "Cuando la etiqueta dice '200 calorías', en realidad son 200 kilocalorías. La caloría científica (cal) es la cantidad de calor para elevar 1 g de agua en 1 °C.",
          asi_no: "Pensar que 1 caloría alimentaria = 1 cal científica: hay un factor de 1000. Una naranja de 50 kcal en etiqueta contiene 50,000 calorías científicas.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Una barra de granola indica: 25 g de carbohidratos, 5 g de proteínas y 10 g de lípidos por porción. Calcula las kilocalorías totales y determina qué macronutriente aporta más energía.",
        },
        {
          tipo: "pasos",
          ancho: 12,
          ...
          pasos: [
            ...
            {
              pre: "Calorías de proteínas: ",
              math: "5 \\times 4 = 20\\,\\text{kcal}",
            },
            {
              pre: "Calorías de lípidos: ",
              math: "10 \\times 9 = 90\\,\\text{kcal}",
            },
            {
              pre: "Total: ",
              math: "100 + 20 + 90 = 210\\,\\text{kcal}",
            },
            {
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "La fotosíntesis y la respiración aeróbica son reacciones químicas inversas entre sí. Compara sus ecuaciones, clasifícalas energéticamente y comprende el ciclo de la materia y la energía.",
        },
        {
          tipo: "pasos",
          ancho: 12,
      ...
      bloques: [
        {
          ...
          enunciado: "La fotosíntesis es una reacción en la que las plantas absorben energía solar para producir glucosa. ¿Cómo se clasifica?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "La combustión de madera en una fogata libera calor y luz. ¿Qué tipo de reacción es?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "La respiración celular aeróbica (C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O + ATP) ¿cómo se clasifica energéticamente?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Una porción de comida tiene 40 g de carbohidratos, 15 g de proteínas y un número desconocido de gramos de lípidos. Si el total es 300 kcal, ¿cuántos gramos de lípidos contiene?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "La 'caloría' indicada en las etiquetas de alimentos equivale a:",
          opciones: [
    ...
    },
    {
      ...
      bloques: [
        ...
        },
        {
          ...
          filas: [
            ["Pesticidas", "Mayor producción agrícola", "Contaminación de suelo y agua"],
            ["Fertilizantes", "Mejoran rendimiento de cultivos", "Eutrofización de ríos y lagos"],
            ["Plásticos", "Materiales versátiles y ligeros", "Contaminación persistente (microplásticos)"],
            ["Combustibles", "Energía para transporte e industria", "CO₂, lluvia ácida, smog"],
          ],
        },
        {
          tipo: "trampa",
          ...
          asi_es: "El flúor en pasta dental previene caries; en dosis bajas es benéfico. El mismo compuesto puede ser medicamento o veneno según la dosis (principio de Paracelso).",
          asi_no: "Asumir que todo lo 'químico' es malo y lo 'natural' es seguro: el arsénico es natural y muy tóxico; muchos medicamentos que salvan vidas son compuestos sintéticos.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Las fábricas y vehículos emiten dióxido de azufre (SO₂) y óxidos de nitrógeno (NOₓ) que reaccionan con la humedad atmosférica formando ácidos que caen como lluvia.",
        },
        {
          tipo: "pasos",
          ancho: 12,
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Los plásticos no se biodegradan: se fragmentan en partículas cada vez más pequeñas llamadas microplásticos (< 5 mm). Estos contaminantes se acumulan en ecosistemas y cadenas tróficas.",
        },
        {
          tipo: "pasos",
          ancho: 12,
      ...
      bloques: [
        {
          ...
          enunciado: "El uso excesivo de fertilizantes químicos en la agricultura provoca que los nutrientes lleguen a ríos y lagos. ¿Cuál es la consecuencia principal?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Los CFCs (clorofluorocarbonos) usados en aerosoles y refrigerantes causaron daño a:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "La lluvia ácida se forma principalmente por:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "¿Cuál es la principal razón por la que los plásticos son contaminantes especialmente problemáticos?",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "El principio de Paracelso afirma: 'la dosis hace el veneno'. ¿Qué ejemplo ilustra mejor este principio?",
          opciones: [
