import{d as S,u as $,r as p,j as e,L as R,h as I,i as E,I as P}from"./index-Dd_dvzpS.js";import{b as M}from"./presentacionesIndex-DxrsRxo-.js";import{b as A}from"./documentosIndex-XoTmcR8c.js";import{o as D}from"./temas-uMIe0hiI.js";import{S as L}from"./SlideRenderer-Mg2-OWOO.js";import{D as B}from"./DocumentoRenderer-B9loR3O_.js";import"./cohesion-textual-exani-ii-CIQzI_SZ.js";import"./index-Dcjdbpkl.js";import"./BarChart-D90NYMaO.js";import"./retroalimentacion-CfNcNvF3.js";import"./Lienzo-CR3K4MYN.js";const O={presentacion:"Presentación",documento:"Documento",cuestionario:"Cuestionario",video:"Video"};function T(){const a=E(),r=p.useRef(null);return p.useEffect(()=>{if(a&&window.katex&&r.current)try{window.katex.render("\\mathbb{R}[i]",r.current,{throwOnError:!1,displayMode:!1})}catch{}},[a]),e.jsxs("span",{className:"cv-brand-name",children:["Facto",e.jsx("span",{className:"cv-brand-math",ref:r,children:"ℝ[i]"}),"zando"]})}function N({icono:a,size:r=20}){const o=P[a];return o?e.jsx(o,{size:r}):e.jsx("span",{children:a})}function w({size:a=18}){return e.jsxs("svg",{width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:[e.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),e.jsx("path",{d:"M9 3v18"})]})}function re(){const{id:a}=S(),r=$(),o=I(a),[x,v]=p.useState(0),[c,m]=p.useState(null),[h,b]=p.useState(()=>typeof window>"u"?!0:window.innerWidth>820),j=p.useMemo(()=>(o?.secciones||[]).flatMap(i=>i.subsecciones.flatMap(s=>s.habilidades||[])),[o]);if(!o)return e.jsxs("div",{style:{minHeight:"100vh",display:"grid",placeItems:"center",fontFamily:"monospace"},children:["Curso no encontrado: ",a]});const g=j.length,y=j.filter(i=>i.completado).length,f=g?Math.round(y/g*100):0,k=Math.max(0,Math.min(3,Math.round(f/100*3))),z=i=>v(s=>s===i?null:i);return e.jsxs("div",{className:"cv-root",children:[e.jsx("style",{children:H}),e.jsxs("header",{className:"cv-top",children:[e.jsxs("div",{className:"cv-brand",children:[e.jsx(R,{to:"/",className:"cv-logo-link",title:"Inicio",children:e.jsx("span",{className:"cv-logo-ring",children:e.jsx("img",{src:"/factorizando/assets/marca/v-avatar.svg",alt:"Factorizando"})})}),e.jsx(T,{}),e.jsx("span",{className:"cv-sep",children:"|"}),e.jsxs("button",{className:"cv-materia-trigger",type:"button",title:"Cambiar materia / curso (próximamente)",children:[o.area,e.jsx("svg",{className:"cv-chevron",width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"m6 9 6 6 6-6"})})]})]}),e.jsxs("div",{className:"cv-progreso",children:[e.jsxs("span",{className:"cv-progreso-txt",children:[y,"/",g," habilidades"]}),e.jsx("div",{className:"cv-bar",children:e.jsx("div",{className:"cv-bar-fill",style:{width:`${f}%`}})}),e.jsxs("span",{className:"cv-stars",children:["★".repeat(k),e.jsx("span",{className:"cv-stars-off",children:"★".repeat(3-k)})]})]}),e.jsx("div",{className:"cv-cuenta",children:e.jsx("span",{className:"cv-avatar",children:"J"})})]}),e.jsxs("div",{className:"cv-body",children:[h?e.jsxs("aside",{className:"cv-side",children:[e.jsxs("div",{className:"cv-side-hd",children:[e.jsxs("span",{className:"cv-side-hd-tit",children:[e.jsx(N,{icono:o.icono,size:24})," ",o.area]}),e.jsx("button",{className:"cv-x",onClick:()=>b(!1),title:"Contraer menú","aria-label":"Contraer menú",children:e.jsx(w,{})})]}),o.secciones.map((i,s)=>{const d=x===s;return e.jsxs("div",{className:"cv-sec",children:[e.jsx("button",{className:"cv-sec-hd",onClick:()=>z(s),children:e.jsxs("div",{className:"cv-sec-tit",children:[e.jsxs("div",{className:"cv-sec-num",children:["Sección ",s+1]}),e.jsx("div",{className:"cv-sec-nombre",children:i.titulo})]})}),d&&e.jsx("div",{className:"cv-sec-body",children:i.subsecciones.map(t=>{if(t.documentoRef||t.proximamente&&!t.habilidades){const n=`${i.id}/${t.id}`,u=c?.key===n,l=!t.documentoRef;return e.jsx("button",{className:`cv-hab${u?" activa":""}${l?" prox":""}`,onClick:()=>!l&&m({hab:{tipo:"documento",ref:t.documentoRef,titulo:t.titulo},key:n}),children:e.jsxs("span",{className:"cv-hab-txt",children:[e.jsx("span",{className:"cv-hab-tit",children:t.titulo}),e.jsxs("span",{className:"cv-hab-meta",children:["Lección",l?" · próximamente":""]})]})},t.id)}return e.jsxs("div",{className:"cv-sub",children:[e.jsx("div",{className:"cv-sub-tit",children:t.titulo}),(t.habilidades||[]).map((n,u)=>{const l=`${i.id}/${t.id}/${u}`,C=c?.key===l;return e.jsx("button",{className:`cv-hab${C?" activa":""}${n.proximamente?" prox":""}`,onClick:()=>!n.proximamente&&m({hab:n,key:l}),children:e.jsxs("span",{className:"cv-hab-txt",children:[e.jsx("span",{className:"cv-hab-tit",children:n.titulo}),e.jsxs("span",{className:"cv-hab-meta",children:[O[n.tipo]||n.tipo,n.duracion?` · ${n.duracion}`:"",n.proximamente?" · próximamente":""]})]})},l)})]},t.id)})})]},i.id)})]}):e.jsxs("nav",{className:"cv-rail",children:[e.jsx("button",{className:"cv-rail-btn",onClick:()=>b(!0),title:"Expandir menú","aria-label":"Expandir menú",children:e.jsx(w,{})}),e.jsx("div",{className:"cv-rail-curso",title:o.area,children:e.jsx(N,{icono:o.icono,size:38})}),e.jsx("div",{className:"cv-rail-secs",children:o.secciones.map((i,s)=>e.jsxs("div",{className:"cv-rail-grupo",children:[e.jsx("button",{className:"cv-rail-sec",title:`Sección ${s+1} · ${i.titulo}`,onClick:()=>{v(s),b(!0)},children:s+1}),e.jsx("div",{className:"cv-rail-dots",children:i.subsecciones.map(d=>{const t=`${i.id}/${d.id}`,n=c?.key===t,u=!d.documentoRef&&!d.habilidades;return e.jsx("button",{className:`cv-rail-dot${n?" activa":""}${u?" prox":""}`,title:d.titulo,"aria-label":d.titulo,onClick:()=>{u||(v(s),d.documentoRef?m({hab:{tipo:"documento",ref:d.documentoRef,titulo:d.titulo},key:t}):b(!0))}},d.id)})})]},i.id))})]}),e.jsx("main",{className:"cv-pizarra",children:c?e.jsx(V,{hab:c.hab,navigate:r},c.key):e.jsx(G,{curso:o,pct:f})})]})]})}function V({hab:a,navigate:r}){return a.tipo==="presentacion"?e.jsx(F,{presId:a.ref}):a.tipo==="documento"?e.jsx(W,{docId:a.ref}):a.tipo==="cuestionario"?e.jsxs("div",{className:"cv-card",children:[e.jsx("h2",{children:a.titulo}),e.jsxs("p",{children:["Cuestionario · ",a.duracion||""]}),a.ref?e.jsx("button",{className:"cv-btn",onClick:()=>r(`/cuestionario/${a.ref}`),children:"Comenzar cuestionario"}):e.jsx("p",{className:"cv-prox",children:"Este cuestionario aún no está disponible."})]}):e.jsx("div",{className:"cv-card",children:e.jsxs("p",{children:["Tipo no soportado: ",a.tipo]})})}function F({presId:a}){const r=M(a),o=D(r?.materia),[x,v]=p.useState(0);if(!r)return e.jsx("div",{className:"cv-card",children:e.jsxs("p",{children:["Presentación no encontrada: ",a]})});const c=r.slides||[],m=c[x];return e.jsxs("div",{className:"cv-pres",children:[e.jsxs("div",{className:"cv-pres-nav",children:[e.jsx("button",{className:"cv-btn-sm",disabled:x===0,onClick:()=>v(h=>Math.max(0,h-1)),children:"‹ Anterior"}),e.jsxs("span",{className:"cv-pres-pos",children:[r.titulo," — ",x+1,"/",c.length]}),e.jsx("button",{className:"cv-btn-sm",disabled:x>=c.length-1,onClick:()=>v(h=>Math.min(c.length-1,h+1)),children:"Siguiente ›"})]}),e.jsx("div",{className:"cv-pres-slide",children:e.jsx(L,{slide:m,tema:o,modo:"alumno"})})]})}function W({docId:a}){const r=A(a);return r?e.jsx(B,{doc:r,embebido:!0}):e.jsx("div",{className:"cv-card",children:e.jsxs("p",{children:["Documento no encontrado: ",a]})})}function G({curso:a,pct:r}){return e.jsxs("div",{className:"cv-bienvenida",children:[e.jsx("div",{className:"cv-bien-ic",children:a.icono}),e.jsx("h1",{children:a.area}),e.jsx("p",{children:"Selecciona una habilidad en el panel de contenido para empezar."}),e.jsx("div",{className:"cv-bien-bar",children:e.jsx("div",{style:{width:`${r}%`}})}),e.jsxs("span",{className:"cv-bien-pct",children:[r,"% completado"]})]})}const H=`
