...
export default function Pe2RomboSVG({ tema }) {
  return (
    <svg viewBox="0 0 280 158" width="100%" style={{ display: "block", maxHeight: 138 }}>
      ...
      <line x1="140" y1="8" x2="140" y2="150" stroke={tema.canal(1)} strokeWidth="1.8" strokeDasharray="6,4" opacity="0.65"/>
      ...
      <text x="148" y="44" fill={tema.canal(1)} fontSize="12" fontFamily="Georgia,serif" fontStyle="italic">d₁=10</text>
