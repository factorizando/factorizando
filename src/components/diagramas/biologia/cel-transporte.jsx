...
export default function CelTransporteSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 280 130" width="100%" style={{ display: "block", maxHeight: 140 }}>
      ...
      <text x={66} y={24} textAnchor="middle" fill={tema.verde} fontSize="8.5" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="600">Pasivo (sin ATP)</text>
      ...
      <text x={88} y={40} textAnchor="middle" fill={tema.verde} fontSize="7" fontFamily="'Figtree', system-ui, sans-serif">a favor</text>
      {/* Activo — flecha en contra con ATP */}
      <text x={62} y={88} textAnchor="middle" fill={tema.rojo} fontSize="8.5" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="600">Activo (con ATP)</text>
      ...
      <text x={92} y={98} textAnchor="middle" fill={tema.rojo} fontSize="7" fontFamily="'Figtree', system-ui, sans-serif">en contra</text>
