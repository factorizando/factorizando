...
export default function EjBarrasDeporteSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 332 164" width="100%" style={{ display: "block", maxHeight: 196 }}>
      <text x="14" y="13" fill={mu} fontSize="9.5" fontFamily="'Figtree', system-ui, sans-serif">frecuencia</text>
      ...
      {bars.map((b, i) => {
        ...
        return (
          <g key={i}>
            ...
            <text x={b.cx} y={base + 15} fill={mu} fontSize="10.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">{b.lab}</text>
          </g>
        );
      })}
    </svg>
