import{c as de,r as o,j as e,a as ze,u as Se,s as g,X as ke}from"./index-JqZUuafo.js";import{C as Ee}from"./chevron-down-Yo-bBx3p.js";import{G as _e,U as De}from"./users-CQvUjFoU.js";import{T as Me}from"./trash-2-3ZrQUASU.js";import{P as Ae}from"./plus-Bl_OEQ_H.js";const Te=[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]],Fe=de("arrow-left",Te);const Pe=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],Le=de("check",Pe),$e=["Aguascalientes","Baja California","Baja California Sur","Campeche","Chiapas","Chihuahua","Ciudad de México","Coahuila","Colima","Durango","Estado de México","Guanajuato","Guerrero","Hidalgo","Jalisco","Michoacán","Morelos","Nayarit","Nuevo León","Oaxaca","Puebla","Querétaro","Quintana Roo","San Luis Potosí","Sinaloa","Sonora","Tabasco","Tamaulipas","Tlaxcala","Veracruz","Yucatán","Zacatecas"];function ee(l){return(l||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()}function $({value:l,onChange:f,options:h=[],placeholder:v="Selecciona…",disabled:C=!1,textoVacio:I="Sin resultados",...B}){const[d,c]=o.useState(!1),[O,y]=o.useState(l||""),[u,z]=o.useState(-1),S=o.useRef(null),D=o.useRef(null),w=`combo-lista-${o.useId().replace(/[^a-zA-Z0-9]/g,"")}`,k=o.useMemo(()=>(h||[]).map(i=>typeof i=="string"?{value:i,label:i}:i),[h]),M=o.useMemo(()=>{const i=k.find(n=>n.value===l);return i?i.label:l||""},[k,l]),p=o.useMemo(()=>{const i=ee(O);return i?k.filter(n=>ee(n.label).includes(i)||ee(n.value).includes(i)):k},[k,O]);function T(){C||(y(""),z(-1),c(!0),requestAnimationFrame(()=>{D.current?.focus()}))}function b(i=!0){c(!1),z(-1),i&&y(M)}function F(i){f(i.value),y(i.label),c(!1),z(-1),D.current?.blur()}o.useEffect(()=>{if(!d)return;const i=n=>{S.current&&!S.current.contains(n.target)&&b(!0)};return document.addEventListener("mousedown",i),document.addEventListener("touchstart",i,{passive:!0}),()=>{document.removeEventListener("mousedown",i),document.removeEventListener("touchstart",i)}},[d]),o.useEffect(()=>{d||y(M)},[M,d]),o.useEffect(()=>{!d||u<0||document.getElementById(`${w}-op-${u}`)?.scrollIntoView({block:"nearest"})},[d,u,w]);const[N,P]=o.useState(0);o.useEffect(()=>{if(!d){P(0);return}const i=window.matchMedia("(max-width: 480px)").matches,n=window.visualViewport;if(!i||!n)return;const m=()=>{P(Math.max(0,window.innerHeight-n.height-(n.offsetTop||0)))};return m(),n.addEventListener("resize",m),n.addEventListener("scroll",m),()=>{n.removeEventListener("resize",m),n.removeEventListener("scroll",m)}},[d]);function L(i){if(i.key==="ArrowDown"||i.key==="ArrowUp"){if(i.preventDefault(),!d){T();return}const n=i.key==="ArrowDown"?1:-1;z(m=>{if(p.length===0)return-1;const E=m+n;return E<0?p.length-1:E>=p.length?0:E})}else i.key==="Enter"?d&&u>=0&&p[u]&&(i.preventDefault(),F(p[u])):i.key==="Escape"&&(i.preventDefault(),b(!0),D.current?.blur())}return e.jsxs("div",{className:"combo",ref:S,children:[e.jsx("style",{children:Ie}),e.jsx("input",{ref:D,className:"combo-entrada",...B,role:"combobox","aria-expanded":d,"aria-controls":w,"aria-activedescendant":u>=0?`${w}-op-${u}`:void 0,"aria-autocomplete":"list",value:d?O:M,placeholder:v,disabled:C,autoComplete:"off",onFocus:()=>{d||T()},onChange:i=>{y(i.target.value),z(-1),d||c(!0)},onKeyDown:L}),e.jsx("button",{type:"button",className:"combo-flecha",tabIndex:-1,"aria-hidden":"true",disabled:C,onClick:()=>d?b(!0):T(),children:e.jsx(Ee,{size:18,className:d?"combo-flecha-arriba":""})}),d&&e.jsx("div",{className:"combo-desplegable",style:N>0?{bottom:12+N}:void 0,children:e.jsx("ul",{className:"combo-lista",role:"listbox",id:w,children:p.length===0?e.jsx("li",{className:"combo-vacio",role:"presentation",children:I}):p.map((i,n)=>{const m=i.value===l;return e.jsxs("li",{id:`${w}-op-${n}`,role:"option","aria-selected":m,className:`combo-opcion${n===u?" combo-opcion-resaltada":""}${m?" combo-opcion-elegida":""}`,onMouseDown:E=>{E.preventDefault(),F(i)},children:[e.jsx("span",{children:i.label}),m&&e.jsx(Le,{size:16,"aria-hidden":"true"})]},i.value)})})})]})}const Ie=`
...
`,Oe=[{v:"primaria",label:"Educación Básica (Primaria)"},{v:"secundaria",label:"Educación Básica (Secundaria)"},{v:"media_superior",label:"Educación Media Superior (Preparatoria/Bachillerato)"},{v:"superior",label:"Educación Superior"}],Re=[{value:"01",label:"Ene"},{value:"02",label:"Feb"},{value:"03",label:"Mar"},{value:"04",label:"Abr"},{value:"05",label:"May"},{value:"06",label:"Jun"},{value:"07",label:"Jul"},{value:"08",label:"Ago"},{value:"09",label:"Sep"},{value:"10",label:"Oct"},{value:"11",label:"Nov"},{value:"12",label:"Dic"}],qe=["Puebla","Veracruz","Estado de México","Ciudad de México"],J=l=>(l||"").toLowerCase().replace(/(^|\s|-)([a-záéíóúñ])/g,(f,h,v)=>h+v.toUpperCase());function ae(l){if(!l)return null;const f=new Date,h=new Date(l);let v=f.getFullYear()-h.getFullYear();const C=f.getMonth()-h.getMonth();return(C<0||C===0&&f.getDate()<h.getDate())&&v--,v>=0&&v<120?v:null}function Be(l,f){if(l==="primaria")return"primaria";if(l==="secundaria")return"secundaria";if(l==="media_superior")return"prepa";if(l==="superior")return"universidad";const h=ae(f);return h!=null&&h<12?"primaria":"secundaria"}const Ge={nombre:"",telefono:"",parentesco:""};function Xe(){ze();const l=Se(),[f,h]=o.useState(null),[v,C]=o.useState(!0),[I,B]=o.useState(!1),[d,c]=o.useState(""),[O,y]=o.useState("tipo"),[u,z]=o.useState(null),[S,D]=o.useState(""),[R,w]=o.useState(""),[k,M]=o.useState(""),[p,T]=o.useState(""),[b,F]=o.useState(""),[N,P]=o.useState(""),[L,i]=o.useState(""),[n,m]=o.useState(""),[E,G]=o.useState(""),[U,V]=o.useState([]),[Q,pe]=o.useState(""),[q,ue]=o.useState(null),[fe,me]=o.useState(""),H=o.useRef(null),[xe,re]=o.useState([]),[te,X]=o.useState([]),[he,Y]=o.useState(!1);o.useEffect(()=>{let a=!1;return g.auth.getSession().then(async({data:{session:r}})=>{if(a)return;if(!r){l("/login?dest=completar-perfil");return}h(r.user.id);const{data:t}=await g.from("profiles").select("nombre, apellidos, telefono, estado, ciudad, fecha_nacimiento, nivel_educativo, institucion, institucion_cct, avatar_url, tipo_solicitado").eq("id",r.user.id).single();if(a)return;if(t){D(t.nombre||""),w(t.apellidos||""),M(t.telefono||""),T(t.estado||"Puebla"),F(t.ciudad||"Tecamachalco"),P(t.fecha_nacimiento||"");{const x=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t.fecha_nacimiento||"");x&&ne({d:x[3],m:x[2],a:x[1]})}i(t.nivel_educativo||""),m(t.institucion||""),G(t.institucion_cct||""),pe(t.avatar_url||""),t.tipo_solicitado&&(z(t.tipo_solicitado),y("form"))}const{data:s}=await g.from("alumnos").select("id").eq("profile_id",r.user.id).maybeSingle();if(s){const{data:x}=await g.from("contactos_emergencia").select("nombre, telefono, relacion, orden").eq("alumno_id",s.id).order("orden");!a&&x&&V(x.map(A=>({nombre:A.nombre,telefono:A.telefono,parentesco:A.relacion})))}C(!1)}),()=>{a=!0}},[l]),o.useEffect(()=>{if(!p){re([]);return}let a=!1;return g.rpc("municipios_por_estado",{p_estado:p}).then(({data:r})=>{a||re((r||[]).map(t=>J(t.municipio)))}),()=>{a=!0}},[p]),o.useEffect(()=>{if(!p){X([]);return}const a=n.trim(),r=b.trim();if(!r&&a.length<3){X([]);return}const t=setTimeout(async()=>{const{data:s}=await g.rpc("buscar_escuelas",{p_estado:p,p_municipio:r||null,p_q:a.length>=2?a:null});X(s||[])},250);return()=>clearTimeout(t)},[n,p,b]);const ge=a=>{const r=a.target.files?.[0];if(r){if(r.size>3*1024*1024){c("La imagen no debe superar 3 MB.");return}c(""),ue(r),me(URL.createObjectURL(r))}},ve=o.useCallback(async()=>{if(!q||!f)return Q;const a=(q.name.split(".").pop()||"jpg").toLowerCase(),r=`${f}/${Date.now()}.${a}`,{error:t}=await g.storage.from("avatars").upload(r,q,{contentType:q.type,upsert:!1});if(t)throw t;const{data:s}=g.storage.from("avatars").getPublicUrl(r);return s.publicUrl},[q,f,Q]);function oe(a){z(a),c(""),y("form")}function Z(a,r,t){V(s=>s.map((x,A)=>A===a?{...x,[r]:t}:x))}const be=()=>V(a=>a.length<2?[...a,{...Ge}]:a),je=a=>V(r=>r.filter((t,s)=>s!==a));async function ye(a){if(a.preventDefault(),c(""),!S.trim()){c("Ingresa tu nombre.");return}if(!R.trim()){c("Ingresa tus apellidos.");return}const r=k.replace(/\D/g,"");if(r.length!==10){c("El teléfono debe tener 10 dígitos.");return}if(u==="alumno"){if(!p){c("Selecciona tu estado.");return}if(!b.trim()){c("Ingresa tu ciudad.");return}if(!N){c("Ingresa tu fecha de nacimiento.");return}const t=ae(N);if(t==null||t<8||t>100){c("Revisa tu fecha de nacimiento: la edad no es válida.");return}if(!L){c("Selecciona tu nivel educativo actual.");return}if(!n.trim()){c("Ingresa tu institución educativa.");return}if(qe.includes(p)&&!E){c("Elige tu escuela de la lista de sugerencias (debe estar en el catálogo).");return}for(const s of U)if(s.nombre.trim()||s.telefono.trim()||s.parentesco.trim()){if(!s.nombre.trim()||!s.telefono.trim()||!s.parentesco.trim()){c("Completa nombre, teléfono y parentesco de cada contacto de emergencia.");return}if(s.telefono.replace(/\D/g,"").length!==10){c("El teléfono de un contacto de emergencia debe tener 10 dígitos.");return}}}B(!0);try{const t=await ve(),s={nombre:S.trim(),apellidos:R.trim(),telefono:r,avatar_url:t||null,perfil_completo:!0,tipo_solicitado:u};u==="alumno"&&Object.assign(s,{estado:p,ciudad:b.trim(),fecha_nacimiento:N,nivel_educativo:L,institucion:n.trim(),institucion_cct:E||null});const{error:x}=await g.from("profiles").update(s).eq("id",f);if(x)throw x;if(u==="alumno"){const A=Be(L,N),{error:se}=await g.from("alumnos").upsert({id:f,profile_id:f,nombre:S.trim(),apellidos:R.trim(),fecha_nacimiento:N,email:null,telefono:r,nivel:A},{onConflict:"id"});if(se)throw se;const{error:ce}=await g.from("contactos_emergencia").delete().eq("alumno_id",f);if(ce)throw ce;const le=U.filter(_=>_.nombre.trim()).map((_,Ce)=>({alumno_id:f,nombre:_.nombre.trim(),telefono:_.telefono.replace(/\D/g,""),relacion:_.parentesco.trim(),orden:Ce+1}));if(le.length){const{error:_}=await g.from("contactos_emergencia").insert(le);if(_)throw _}}l("/cuenta-pendiente")}catch(t){console.error(t),c("No se pudo guardar tu perfil. Intenta de nuevo."),B(!1)}}const ie=ae(N),K=fe||Q,[j,ne]=o.useState({d:"",m:"",a:""}),we=o.useMemo(()=>{const a=new Date().getFullYear()-8,r=[];for(let t=a;t>=a-92;t--)r.push(String(t));return r},[]),Ne=o.useMemo(()=>{const a=j.m&&j.a?new Date(Number(j.a),Number(j.m),0).getDate():31,r=[];for(let t=1;t<=a;t++)r.push(String(t).padStart(2,"0"));return r},[j.m,j.a]);function W(a){const r={...j,...a};if(ne(r),!r.d||!r.m||!r.a){P("");return}const t=new Date(Number(r.a),Number(r.m),0).getDate(),s=String(Math.min(Number(r.d),t)).padStart(2,"0");P(`${r.a}-${r.m}-${s}`)}return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:Ue}),e.jsx("div",{className:"cp-root",children:e.jsx("div",{className:"cp-card",children:v?e.jsxs("div",{className:"cp-loading",children:[e.jsx("span",{className:"cp-spinner"})," Cargando…"]}):O==="tipo"?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cp-head",children:[e.jsx("span",{className:"cp-eyebrow",children:"Casi listo"}),e.jsx("h1",{className:"cp-title",children:"¿Qué tipo de cuenta es?"}),e.jsx("p",{className:"cp-sub",children:"Elige una opción para continuar. El administrador revisará tu solicitud."})]}),e.jsxs("div",{className:"cp-tipos",children:[e.jsxs("button",{type:"button",className:`cp-tipo${u==="alumno"?" cp-tipo-on":""}`,onClick:()=>oe("alumno"),children:[e.jsx("span",{className:"cp-tipo-ic",children:e.jsx(_e,{size:24,"aria-hidden":"true"})}),e.jsx("span",{className:"cp-tipo-tit",children:"Alumno"}),e.jsx("span",{className:"cp-tipo-txt",children:"Voy a tomar clases y quiero ver mi avance."})]}),e.jsxs("button",{type:"button",className:`cp-tipo${u==="tutor"?" cp-tipo-on":""}`,onClick:()=>oe("tutor"),children:[e.jsx("span",{className:"cp-tipo-ic",children:e.jsx(De,{size:24,"aria-hidden":"true"})}),e.jsx("span",{className:"cp-tipo-tit",children:"Tutor"}),e.jsx("span",{className:"cp-tipo-txt",children:"Acompaño a uno o varios alumnos."})]})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cp-head",children:[e.jsxs("button",{type:"button",className:"cp-volver",onClick:()=>y("tipo"),children:[e.jsx(Fe,{size:15,"aria-hidden":"true"})," Cambiar tipo"]}),e.jsx("span",{className:"cp-eyebrow",children:"Casi listo"}),e.jsx("h1",{className:"cp-title",children:u==="alumno"?"Completa tu perfil de alumno":"Completa tu perfil de tutor"}),e.jsx("p",{className:"cp-sub",children:u==="alumno"?"Necesitamos estos datos para personalizar tu preparación.":"Solo lo básico para identificarte."})]}),e.jsxs("form",{className:"cp-form",onSubmit:ye,children:[e.jsxs("div",{className:"cp-avatar-row",children:[e.jsx("div",{className:"cp-avatar",onClick:()=>H.current?.click(),children:K?e.jsx("img",{src:K,alt:"avatar"}):e.jsx("span",{className:"cp-avatar-ph",children:"＋"})}),e.jsxs("div",{className:"cp-avatar-txt",children:[e.jsx("button",{type:"button",className:"cp-avatar-btn",onClick:()=>H.current?.click(),children:K?"Cambiar foto":"Subir foto"}),e.jsx("span",{className:"cp-hint",children:"JPG o PNG, máx. 3 MB"})]}),e.jsx("input",{ref:H,type:"file",accept:"image/*",hidden:!0,onChange:ge})]}),e.jsxs("div",{className:"cp-grid2",children:[e.jsxs("div",{className:"cp-field",children:[e.jsx("label",{children:"Nombre(s)"}),e.jsx("input",{value:S,onChange:a=>D(a.target.value),placeholder:"Ej. Ana"})]}),e.jsxs("div",{className:"cp-field",children:[e.jsx("label",{children:"Apellidos"}),e.jsx("input",{value:R,onChange:a=>w(a.target.value),placeholder:"Ej. López García"})]})]}),e.jsxs("div",{className:"cp-field",children:[e.jsx("label",{children:"Teléfono (WhatsApp)"}),e.jsx("input",{type:"tel",value:k,onChange:a=>M(a.target.value),placeholder:"Ej. 2221234567"})]}),u==="alumno"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"cp-field",children:[e.jsxs("label",{children:["Fecha de nacimiento ",ie!=null&&e.jsxs("span",{className:"cp-edad",children:["· ",ie," años"]})]}),e.jsxs("div",{className:"cp-fecha",children:[e.jsx($,{value:j.d,onChange:a=>W({d:a}),options:Ne,placeholder:"Día","aria-label":"Día de nacimiento"}),e.jsx($,{value:j.m,onChange:a=>W({m:a}),options:Re,placeholder:"Mes","aria-label":"Mes de nacimiento"}),e.jsx($,{value:j.a,onChange:a=>W({a}),options:we,placeholder:"Año","aria-label":"Año de nacimiento"})]})]}),e.jsxs("div",{className:"cp-grid2",children:[e.jsxs("div",{className:"cp-field",children:[e.jsx("label",{children:"Estado"}),e.jsx($,{value:p,onChange:a=>{T(a),F(""),m(""),G("")},options:$e,placeholder:"Selecciona…"})]}),e.jsxs("div",{className:"cp-field",children:[e.jsx("label",{children:"Ciudad / Municipio"}),e.jsx($,{value:b,onChange:F,options:xe,placeholder:p?"Escribe o elige tu municipio":"Primero elige tu estado",textoVacio:p?"Sin resultados":"Primero elige tu estado"})]})]}),e.jsxs("div",{className:"cp-field",children:[e.jsx("label",{children:"Nivel educativo actual"}),e.jsx($,{value:L,onChange:i,options:Oe.map(a=>({value:a.v,label:a.label})),placeholder:"Selecciona…"})]}),e.jsxs("div",{className:"cp-field cp-autocomplete",children:[e.jsx("label",{children:"Institución educativa"}),e.jsx("input",{value:n,onChange:a=>{m(a.target.value),G(""),Y(!0)},onFocus:()=>Y(!0),onBlur:()=>setTimeout(()=>Y(!1),150),placeholder:b?"Elige tu escuela, o busca por nombre o CCT":"Escribe el nombre o la CCT de tu escuela",autoComplete:"off"}),he&&te.length>0&&e.jsx("ul",{className:"cp-sug",children:te.map(a=>e.jsxs("li",{onMouseDown:()=>{m(a.nombre),G(a.cct),Y(!1)},children:[e.jsx("span",{className:"cp-sug-nombre",children:a.nombre}),e.jsx("span",{className:"cp-sug-meta",children:(()=>{const r=[J(a.servicio),J(a.municipio),J(a.localidad)].filter(Boolean);return a.localidad?r.join(" · "):[a.cct,...r].filter(Boolean).join(" · ")})()})]},a.cct))})]}),e.jsxs("div",{className:"cp-contactos",children:[e.jsxs("span",{className:"cp-contactos-tit",children:["Contactos de emergencia ",e.jsx("span",{className:"cp-hint",children:"(opcional, hasta 2)"})]}),U.map((a,r)=>e.jsxs("div",{className:"cp-contacto",children:[e.jsxs("div",{className:"cp-contacto-campos",children:[e.jsx("input",{value:a.nombre,onChange:t=>Z(r,"nombre",t.target.value),placeholder:"Nombre"}),e.jsx("input",{value:a.telefono,onChange:t=>Z(r,"telefono",t.target.value),placeholder:"Teléfono",inputMode:"numeric"}),e.jsx("input",{value:a.parentesco,onChange:t=>Z(r,"parentesco",t.target.value),placeholder:"Parentesco (madre, tío…)"})]}),e.jsx("button",{type:"button",className:"cp-contacto-x",onClick:()=>je(r),"aria-label":"Quitar contacto",children:e.jsx(Me,{size:16,"aria-hidden":"true"})})]},r)),U.length<2&&e.jsxs("button",{type:"button",className:"cp-agregar",onClick:be,children:[e.jsx(Ae,{size:15,"aria-hidden":"true"})," Agregar contacto"]})]})]}),d&&e.jsxs("div",{className:"cp-error",children:[e.jsx(ke,{size:15,"aria-hidden":"true"})," ",e.jsx("span",{children:d})]}),e.jsxs("button",{type:"submit",className:"cp-submit",disabled:I,children:[I&&e.jsx("span",{className:"cp-spinner cp-spinner-w"}),I?"Guardando…":"Guardar y continuar"]})]})]})})})]})}const Ue=`
