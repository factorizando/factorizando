...
export default function EjCongLLLSVG({ tema }) {
  return (
    <svg viewBox="0 0 330 138" width="100%" style={{ display: "block", maxHeight: 160 }}>
      ...
      <line x1="10"  y1="112" x2="155" y2="112" stroke={tema.canal(1)}  strokeWidth="2.5"/>
      <line x1="170" y1="112" x2="315" y2="112" stroke={tema.canal(1)}  strokeWidth="2.5"/>
      ...
      <path d="M 78,106 L 78,118 M 87,106 L 87,118"    stroke={tema.canal(1)}  strokeWidth="2" fill="none"/>
      <path d="M 238,106 L 238,118 M 247,106 L 247,118" stroke={tema.canal(1)}  strokeWidth="2" fill="none"/>
      ...
      <text x="82"  y="127" fill={tema.canal(1)}  fontSize="13" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="middle">6</text>
      ...
      <text x="242" y="127" fill={tema.canal(1)}  fontSize="13" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="middle">6</text>
