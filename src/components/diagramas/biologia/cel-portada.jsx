...
export default function CelPortadaSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 220 150" width="100%" style={{ display: "block", maxHeight: 150, maxWidth: 280 }}>
      ...
      {/* mitocondrias */}
      <ellipse cx={56} cy={48} rx={15} ry={7.5} fill={`${tema.canal(2)}2e`} stroke={tema.canal(2)} strokeWidth="1.6" transform="rotate(-20 56 48)" />
      <ellipse cx={160} cy={104} rx={15} ry={7.5} fill={`${tema.canal(2)}2e`} stroke={tema.canal(2)} strokeWidth="1.6" transform="rotate(15 160 104)" />
      {/* organelos varios */}
