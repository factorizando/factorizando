...
export default function AntonimiaContextualSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 520 118" width="100%" style={{ display: "block" }}>
      <text x="260" y="12" fill={tema.muted} fontSize="7.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle" letterSpacing="0.14em" fontWeight="600">EL ANTÓNIMO ES RELATIVO AL MARCO DE REFERENCIA</text>
      {/* Left box */}
      <rect x="5" y="18" width="230" height="96" rx="7" fill={`${az}10`} stroke={`${az}44`} strokeWidth="1.5"/>
      <text x="120" y="34" fill={az} fontSize="8.5" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="middle" letterSpacing="0.1em">ESCALA: ELEFANTES</text>
      ...
      <text x="120" y="87" fill={tema.muted} fontSize="8" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">≈ 3 metros de altura</text>
      ...
      <text x="260" y="77" fill={tema.muted} fontSize="7.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">referente</text>
      <text x="260" y="89" fill={tema.muted} fontSize="7.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">distinto</text>
      {/* Right box */}
      <rect x="285" y="18" width="230" height="96" rx="7" fill={`${vd}10`} stroke={`${vd}44`} strokeWidth="1.5"/>
      <text x="400" y="34" fill={vd} fontSize="8.5" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700" textAnchor="middle" letterSpacing="0.1em">ESCALA: HORMIGAS</text>
      ...
      <text x="400" y="87" fill={tema.muted} fontSize="8" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">≈ 1 centímetro</text>
