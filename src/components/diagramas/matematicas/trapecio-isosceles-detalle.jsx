...
export default function TrapIsoDetalleSVG({ tema }) {
  return (
    <svg viewBox="0 0 430 185" width="100%" style={{ display: "block", maxHeight: 185 }}>
      ...
      <line x1="100" y1="25" x2="310" y2="25" stroke={tema.canal(1)} strokeWidth="2.5" opacity="0.9"/>
      ...
      <line x1="100" y1="25" x2="100" y2="155" stroke={tema.canal(1)} strokeWidth="1.5" strokeDasharray="6,4" opacity="0.6"/>
      <path d="M 100,143 L 110,143 L 110,155" stroke={tema.canal(1)} strokeWidth="1.5" fill="none" opacity="0.6"/>
      <text x="205" y="175" fill={tema.azul} fontSize="15" fontFamily="Georgia,serif" fontStyle="italic" textAnchor="middle">B</text>
      <text x="205" y="18" fill={tema.canal(1)} fontSize="15" fontFamily="Georgia,serif" fontStyle="italic" textAnchor="middle">b</text>
      <text x="86" y="92" fill={tema.canal(1)} fontSize="14" fontFamily="Georgia,serif" fontStyle="italic" textAnchor="end">h</text>
