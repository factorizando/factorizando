import{a as q,u as E,r as o,s,j as a,L as p}from"./index-DATqdMx1.js";const A={primaria:"Primaria",secundaria:"Secundaria",prepa:"Preparatoria",universidad:"Universidad"},L="activo";function O(){q();const N=E(),[w,f]=o.useState(!0),[l,z]=o.useState(null),[n,k]=o.useState(null),[u,c]=o.useState([]),[x,m]=o.useState(null),[h,g]=o.useState("");async function v(e){const{data:r}=await s.from("alumnos").select("id, nombre, apellidos, nivel").eq("profile_id",e).maybeSingle();if(k(r||null),!r){c([]);return}const{data:i}=await s.from("alumno_tutor").select("tutor_id, estado").eq("alumno_id",r.id),d=[...new Set((i||[]).map(t=>t.tutor_id))];if(d.length===0){c([]);return}const{data:_}=await s.from("profiles").select("id, nombre, apellidos, relacion").in("id",d),C=Object.fromEntries((_||[]).map(t=>[t.id,t]));c((i||[]).map(t=>({...C[t.tutor_id],estado:t.estado})).filter(t=>t.id))}o.useEffect(()=>{let e=!1;return(async()=>{const{data:{session:r}}=await s.auth.getSession();if(e)return;if(!r){f(!1);return}const{data:i}=await s.from("profiles").select("nombre, bloque").eq("id",r.user.id).single();e||(z(i),await v(r.user.id),f(!1))})(),()=>{e=!0}},[]);async function b(e,r){g(""),m(e);const{error:i}=await s.rpc("resolver_vinculo_tutor",{p_tutor_id:e,p_aceptar:r});if(i){g(i.message||"No se pudo resolver la solicitud."),m(null);return}const{data:{session:d}}=await s.auth.getSession();await v(d.user.id),m(null)}async function S(){await s.auth.signOut(),N("/login",{replace:!0})}const j=u.filter(e=>e.estado==="pendiente"),y=u.filter(e=>e.estado===L);return a.jsxs("div",{className:"al-root",children:[a.jsx("style",{children:P}),a.jsxs("header",{className:"al-top",children:[a.jsxs(p,{to:"/",className:"al-marca",children:[a.jsx("img",{src:"/factorizando/assets/marca/v-avatar.svg",alt:"",width:"30",height:"30"}),a.jsx("span",{children:"Factoℝ[i]zando"})]}),a.jsxs("div",{className:"al-cuenta",children:[l?.nombre&&a.jsx("span",{className:"al-nombre",children:l.nombre}),a.jsx(p,{to:"/mis-datos",className:"al-ghost",style:{textDecoration:"none"},children:"Mis datos"}),a.jsx("button",{type:"button",onClick:S,className:"al-ghost",children:"Cerrar sesión"})]})]}),a.jsx("main",{className:"al-main",children:w?a.jsx("p",{className:"al-muted",children:"Cargando…"}):n?a.jsxs(a.Fragment,{children:[a.jsxs("header",{className:"al-cab",children:[a.jsx("span",{className:"al-eyebrow",children:"Mi perfil"}),a.jsxs("h1",{className:"al-h1",children:[n.nombre," ",n.apellidos]}),a.jsx("p",{className:"al-sub",children:A[n.nivel]||n.nivel}),l?.bloque&&a.jsx("div",{className:"al-acciones",children:a.jsx(p,{className:"al-btn",to:`/${l.bloque}`,children:"Ir a mi material"})})]}),h&&a.jsx("div",{className:"al-alerta al-alerta-error",children:h}),a.jsxs("section",{className:"al-sec",children:[a.jsx("h2",{className:"al-h2",children:"Solicitudes de tutores"}),j.length===0?a.jsx("p",{className:"al-muted",children:"No tienes solicitudes pendientes."}):j.map(e=>a.jsxs("div",{className:"al-tutor",children:[a.jsx("span",{className:"al-avatar",children:(e.nombre||"?").slice(0,1).toUpperCase()}),a.jsxs("div",{className:"al-tutor-txt",children:[a.jsxs("div",{className:"al-tutor-nombre",children:[e.nombre," ",e.apellidos]}),a.jsxs("div",{className:"al-tutor-meta",children:[e.relacion," · quiere ser tu tutor"]})]}),a.jsxs("div",{className:"al-tutor-acciones",children:[a.jsx("button",{type:"button",className:"al-btn",disabled:x===e.id,onClick:()=>b(e.id,!0),children:x===e.id?"…":"Aceptar"}),a.jsx("button",{type:"button",className:"al-ghost",disabled:x===e.id,onClick:()=>b(e.id,!1),children:"Rechazar"})]})]},e.id))]}),a.jsxs("section",{className:"al-sec",children:[a.jsx("h2",{className:"al-h2",children:"Mis tutores"}),y.length===0?a.jsx("p",{className:"al-muted",children:"Todavía no tienes tutores confirmados."}):y.map(e=>a.jsxs("div",{className:"al-tutor",children:[a.jsx("span",{className:"al-avatar",children:(e.nombre||"?").slice(0,1).toUpperCase()}),a.jsxs("div",{className:"al-tutor-txt",children:[a.jsxs("div",{className:"al-tutor-nombre",children:[e.nombre," ",e.apellidos]}),a.jsx("div",{className:"al-tutor-meta",children:e.relacion})]}),a.jsx("span",{className:"al-badge",children:"Vinculado"})]},e.id))]})]}):a.jsxs("div",{className:"al-vacio",children:[a.jsx("h1",{children:"Tu perfil de alumno aún no está listo"}),a.jsx("p",{children:"Pide al administrador que cree tu expediente para ver tus cursos y tu avance."})]})})]})}const P=`
