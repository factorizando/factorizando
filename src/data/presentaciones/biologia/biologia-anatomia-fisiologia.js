  ...
  slides: [
      ...
      bloques: [
        ...
        },
        {
          ...
          items: [
            {
              math: "\\text{Epitelial}",
              texto: "recubre y protege superficies (piel, mucosas) y forma glándulas",
            },
            {
              math: "\\text{Conectivo}",
              texto: "une y sostiene; incluye la SANGRE, la linfa, el hueso y el cartílago",
            },
            {
              math: "\\text{Muscular}",
              texto: "se contrae y produce movimiento (esquelético, liso y cardiaco)",
            },
            {
              math: "\\text{Nervioso}",
              texto: "recibe y transmite impulsos; formado por neuronas",
            },
          ],
        },
        {
          tipo: "nota",
          texto: "Un tejido es un conjunto de células parecidas que cumplen una misma función; varios tejidos forman un órgano. La SANGRE es un tejido conectivo líquido: transporta oxígeno y dióxido de carbono, y contiene glóbulos blancos (leucocitos) que defienden al cuerpo de organismos patógenos. El tejido linfático también defiende, pero no transporta gases.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "Es el tejido de los mamíferos que contiene células de defensa contra patógenos y, además, transporta oxígeno y dióxido de carbono:",
      ...
      bloques: [
        {
          ...
          enunciado: "El tejido que recubre y protege las superficies del cuerpo (como la piel y las mucosas) es el:",
      ...
      bloques: [
        {
          ...
          enunciado: "La sangre, el hueso y el cartílago pertenecen al tejido:",
      ...
      bloques: [
        {
          ...
          enunciado: "El tejido encargado de producir movimiento mediante la contracción es el:",
      ...
      bloques: [
        {
          ...
          enunciado: "Las neuronas, células que reciben y transmiten impulsos, forman el tejido:",
      ...
      bloques: [
        {
          ...
          enunciado: "Las células de la sangre que actúan como medio de defensa eliminando organismos patógenos son los:",
          opciones: [
      ...
      bloques: [
        {
          ...
          enunciado: "Un grupo de células parecidas que realizan en conjunto una misma función se denomina:",
      ...
      bloques: [
        {
          ...
          enunciado: "Ordena correctamente los niveles de organización del cuerpo, de menor a mayor:",
          opciones: [
            "Célula → tejido → órgano → sistema",
            "Tejido → célula → órgano → sistema",
            "Órgano → tejido → célula → sistema",
            "Sistema → órgano → célula → tejido",
          ],
          correcta: 0,
      ...
      bloques: [
        {
          ...
          enunciado: "El tejido que defiende al organismo pero NO transporta oxígeno ni dióxido de carbono es el:",
      ...
      bloques: [
        {
          ...
          enunciado: "Las glándulas que secretan sustancias (como sudor o saliva) derivan principalmente del tejido:",
    ...
    },
    {
      ...
      bloques: [
        {
          tipo: "destacado",
          texto: "Las plantas tienen tejidos conductores: el XILEMA lleva agua y sales minerales desde la raíz hasta las hojas, y el FLOEMA reparte la savia con azúcares producidos en la fotosíntesis. El intercambio de gases (entrada de CO₂, salida de O₂) y la transpiración ocurren por los ESTOMAS, poros de la epidermis de las hojas.",
        },
        {
          tipo: "figura",
          ancho: 6,
        ...
        },
        {
          ...
          revelar: true,
          etiqueta: "Por qué",
          texto: "Además de fabricar azúcares, las plantas producen metabolitos secundarios: sustancias que no usan para crecer, sino para defenderse. Muchos son ALCALOIDES, como la morfina (de la amapola), la cafeína, la nicotina o la quinina. De ellos se obtienen medicamentos y drogas.",
        },
        {
          tipo: "formula",
          math: "\\text{amapola} \\to \\text{alcaloides} \\to \\text{morfina (analgésico)}",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "Es la estructura de la planta que interviene en el intercambio de gases:",
      ...
      bloques: [
        {
          ...
          enunciado: "El tejido conductor que transporta agua y sales minerales desde la raíz hacia las hojas es el:",
      ...
      bloques: [
        {
          ...
          enunciado: "El tejido que distribuye los azúcares producidos en la fotosíntesis hacia el resto de la planta es el:",
      ...
      bloques: [
        {
          ...
          enunciado: "Es el producto que se obtiene de los alcaloides derivados de la síntesis de aminoácidos de la planta amapola (Papaver somniferum):",
      ...
      bloques: [
        {
          ...
          enunciado: "La morfina, la cafeína y la nicotina son ejemplos de metabolitos secundarios del tipo:",
      ...
      bloques: [
        {
          ...
          enunciado: "La pérdida de agua en forma de vapor a través de los estomas de las hojas se llama:",
      ...
      bloques: [
        {
          ...
          enunciado: "Durante el día, por los estomas de la hoja entra principalmente el gas ____ que la planta usa en la fotosíntesis.",
      ...
      bloques: [
        {
          ...
          enunciado: "El conjunto de sustancias que la planta NO necesita para crecer, sino que produce sobre todo para defenderse, se conoce como:",
      ...
      bloques: [
        {
          ...
          enunciado: "Las células oclusivas (de guarda) regulan en la hoja la apertura y el cierre del:",
      ...
      bloques: [
        {
          ...
          enunciado: "La quinina (contra la malaria) y la cafeína se obtienen de plantas y, por su origen y estructura, se clasifican como:",
      ...
      bloques: [
        {
          ...
          enunciado: "Si se taparan todos los estomas de una hoja, la planta dejaría de poder:",
          opciones: [
            "Intercambiar gases con el aire",
            "Crecer en altura solamente",
            "Tener raíces",
      ...
      bloques: [
        ...
        },
        {
          ...
          items: [
            {
              math: "\\text{Nefridios}",
              texto: "anélidos (lombriz de tierra) y moluscos: tubos que filtran desechos",
            },
            {
              math: "\\text{Túbulos de Malpighi}",
              texto: "insectos y arácnidos (saltamontes, abeja, araña)",
            },
            {
              math: "\\text{Glándulas antenales}",
              texto: "crustáceos (cangrejo, langosta); también llamadas glándulas verdes",
            },
            {
              math: "\\text{Riñones}",
              texto: "vertebrados (peces, anfibios, reptiles, aves y mamíferos)",
            },
          ],
        },
        {
          tipo: "nota",
          texto: "La excreción elimina los desechos del metabolismo (como el amoniaco, la urea o el ácido úrico). Cada gran grupo animal tiene su propia estructura excretora: los anélidos usan nefridios; los insectos y arácnidos, túbulos de Malpighi; los crustáceos, glándulas antenales (verdes); y los vertebrados, riñones.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "Estructura excretora característica de los insectos, como el saltamontes y la abeja:",
      ...
      bloques: [
        {
          ...
          enunciado: "La lombriz de tierra y otros anélidos eliminan sus desechos mediante:",
      ...
      bloques: [
        {
          ...
          enunciado: "Los crustáceos como el cangrejo y la langosta excretan a través de las:",
      ...
      bloques: [
        {
          ...
          enunciado: "Relaciona cada organismo con su estructura de excreción: 1) Lombriz 2) Saltamontes 3) Cangrejo, con a) Nefridios b) Túbulos de Malpighi c) Glándulas antenales.",
      ...
      bloques: [
        {
          ...
          enunciado: "El órgano excretor de los vertebrados (peces, aves y mamíferos) es el:",
      ...
      bloques: [
        {
          ...
          enunciado: "La función general de la excreción en los animales es:",
          opciones: [
            "Eliminar los desechos del metabolismo",
            "Producir energía a partir de glucosa",
            "Reproducir al organismo",
      ...
      bloques: [
        {
          ...
          enunciado: "Una araña, por ser un arácnido, comparte su tipo de estructura excretora con:",
          opciones: [
            "Los insectos (túbulos de Malpighi)",
            "Los anélidos (nefridios)",
            "Los crustáceos (glándulas antenales)",
      ...
      bloques: [
        {
          ...
          enunciado: "Principal desecho nitrogenado que los mamíferos eliminan en la orina:",
      ...
      bloques: [
        {
          ...
          enunciado: "Al filtrar la sangre, los riñones de los vertebrados ayudan a mantener constante el medio interno. Esto es un ejemplo de:",
      ...
      bloques: [
        ...
        },
        {
          ...
          items: [
            {
              math: "\\text{Hifa}",
              texto: "filamento de células que crece y se ramifica; unidad básica del cuerpo",
            },
            {
              math: "\\text{Micelio}",
              texto: "masa entretejida de hifas; forma el cuerpo de la mayoría de los hongos",
            },
            {
              math: "\\text{Pared de quitina}",
              texto: "sus células tienen pared, pero NO de celulosa como las plantas",
            },
            {
              math: "\\text{Heterótrofos}",
              texto: "se nutren por absorción; no fotosintetizan; se reproducen por esporas",
            },
          ],
        },
        {
          tipo: "nota",
          texto: "El cuerpo de la mayoría de los hongos (excepto los unicelulares, como las levaduras) está formado por el MICELIO, una masa entretejida de filamentos de una célula de espesor llamados HIFAS. Los hongos son eucariotas heterótrofos con pared celular de quitina; se alimentan por absorción y se reproducen mediante esporas. Incluyen mohos, levaduras y setas.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "El cuerpo de la mayoría de los miembros del reino Fungi (excepto los unicelulares) está formado por el ________, una masa entretejida de filamentos llamados hifas.",
      ...
      bloques: [
        {
          ...
          enunciado: "Cada uno de los filamentos que, entretejidos, forman el cuerpo de un hongo se llama:",
      ...
      bloques: [
        {
          ...
          enunciado: "La pared celular de los hongos está formada principalmente por:",
      ...
      bloques: [
        {
          ...
          enunciado: "Respecto a su nutrición, los hongos son organismos:",
          opciones: [
            "Heterótrofos que absorben su alimento",
            "Autótrofos que hacen fotosíntesis",
            "Quimiosintéticos del azufre",
      ...
      bloques: [
        {
          ...
          enunciado: "Los hongos se reproducen principalmente mediante:",
      ...
      bloques: [
        {
          ...
          enunciado: "Las levaduras, mohos y setas pertenecen al reino:",
      ...
      bloques: [
        {
          ...
          enunciado: "La parte visible y reproductora de una seta, que produce y libera las esporas, es el:",
      ...
      bloques: [
        {
          ...
          enunciado: "Hongo unicelular usado para fermentar pan, vino y cerveza:",
      ...
      bloques: [
        {
          ...
          enunciado: "En los ecosistemas, muchos hongos cumplen el papel ecológico de:",
      ...
      bloques: [
        {
          ...
          enunciado: "El antibiótico penicilina se obtuvo originalmente de un:",
      ...
      bloques: [
        {
          ...
          items: [
            {
              math: "\\text{Censo}",
              texto: "contar TODOS los individuos de una población (recuento completo)",
            },
            {
              math: "\\text{Muestreo}",
              texto: "estudiar una parte representativa para estimar el total",
            },
            {
              math: "\\text{Observación}",
              texto: "registrar comportamiento o características sin contar a todos",
            },
            {
              math: "\\text{Colecta}",
              texto: "recoger ejemplares para identificarlos y conservarlos",
            },
          ],
        },
        {
          tipo: "nota",
          texto: "Para estudiar la biodiversidad de un lugar, el biólogo elige una técnica. El CENSO cuenta a todos los individuos (útil cuando son pocos o están delimitados, como las plantas de un lago). El MUESTREO estima a partir de una porción. La OBSERVACIÓN y la COLECTA sirven para describir o identificar especies, no para cuantificar la población completa.",
        },
      ],
    },
    {
      ...
      bloques: [
        {
          ...
          enunciado: "¿Qué técnica se aplica para estudiar la variedad de plantas de lirio acuático que crecen en un lago, contando todos sus individuos?",
      ...
      bloques: [
        {
          ...
          enunciado: "Cuando una población es demasiado grande para contarla por completo, se estudia una parte representativa. Esta técnica se llama:",
      ...
      bloques: [
        {
          ...
          enunciado: "Recoger ejemplares de plantas o animales para identificarlos y conservarlos en una colección se denomina:",
      ...
      bloques: [
        {
          ...
          enunciado: "Registrar el comportamiento de las aves de un parque sin capturarlas ni contarlas todas corresponde a la técnica de:",
      ...
      bloques: [
        {
          ...
          enunciado: "La principal diferencia entre un censo y un muestreo es que el censo:",
          opciones: [
            "Cuenta a todos los individuos, no solo a una parte",
            "Solo sirve para plantas",
            "No usa números",
      ...
      bloques: [
        {
          ...
          enunciado: "Para conocer cuántos árboles de una especie hay en un pequeño parque urbano cercado, lo más adecuado es realizar un:",
      ...
      bloques: [
        {
          ...
          items: [
            {
              math: "\\text{Tejidos}",
              texto: "epitelial (recubre), conectivo (sangre, hueso), muscular (mueve), nervioso (transmite). La sangre transporta gases y defiende",
            },
            {
              math: "\\text{xilema / floema}",
              texto: "xilema sube agua de la raíz; floema reparte azúcares; los estomas intercambian gases",
            },
            {
              math: "\\text{Alcaloides}",
              texto: "metabolitos secundarios vegetales: morfina (amapola), cafeína, nicotina, quinina",
            },
            {
              math: "\\text{Excreción}",
              texto: "nefridios (anélidos), túbulos de Malpighi (insectos), glándulas antenales (crustáceos), riñones (vertebrados)",
            },
            {
              math: "\\text{Fungi}",
              texto: "cuerpo = micelio (hifas); pared de quitina; heterótrofos por absorción; esporas",
            },
            {
              math: "\\text{Censo vs. muestreo}",
              texto: "censo = contar a todos; muestreo = estimar con una parte representativa",
            },
          ],
        },
      ],
