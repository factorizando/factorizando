import{a as _,r,s as d,j as t,L as k,u as C}from"./index-DATqdMx1.js";const S={primaria:"Primaria",secundaria:"Secundaria",prepa:"Preparatoria",universidad:"Universidad"};function E(o){if(!o)return null;const i=new Date,n=new Date(o);let l=i.getFullYear()-n.getFullYear();const s=i.getMonth()-n.getMonth();return(s<0||s===0&&i.getDate()<n.getDate())&&l--,l>=0&&l<120?l:null}function P({nombre:o}){const i=C(),n=async()=>{await d.auth.signOut(),i("/login",{replace:!0})};return t.jsxs("header",{className:"tut-top",children:[t.jsxs(k,{to:"/",className:"tut-marca",children:[t.jsx("img",{src:"/factorizando/assets/marca/v-avatar.svg",alt:"",width:"30",height:"30"}),t.jsx("span",{children:"Factoℝ[i]zando"})]}),t.jsxs("div",{className:"tut-cuenta",children:[o&&t.jsx("span",{className:"tut-nombre",children:o}),t.jsx(k,{to:"/mis-datos",className:"tut-ghost",style:{textDecoration:"none"},children:"Mis datos"}),t.jsx("button",{type:"button",onClick:n,className:"tut-ghost",children:"Cerrar sesión"})]})]})}function T({onClose:o,onSolicitado:i}){const[n,l]=r.useState(""),[s,N]=r.useState(""),[h,g]=r.useState(!1),[f,v]=r.useState(null),[b,c]=r.useState(""),[j,a]=r.useState(null),[u,x]=r.useState("");async function y(e){if(e?.preventDefault(),c(""),x(""),!n.trim()&&!s.trim()){c("Escribe el correo o el teléfono del alumno.");return}g(!0);const{data:m,error:p}=await d.rpc("buscar_alumno_para_tutor",{p_email:n.trim()||null,p_telefono:s.trim()||null});if(g(!1),p){c("No se pudo buscar. Intenta de nuevo.");return}v(m||[])}async function w(e){c(""),x(""),a(e.id);const{error:m}=await d.rpc("solicitar_vinculo_tutor",{p_alumno_id:e.id});if(a(null),m){c(m.message||"No se pudo solicitar el vínculo.");return}x(`Solicitud enviada a ${e.nombre} ${e.apellidos}. Debe confirmarla desde su cuenta.`),v(p=>(p||[]).map(z=>z.id===e.id?{...z,ya_vinculado:!0}:z)),i?.()}return t.jsx("div",{className:"tut-overlay",onMouseDown:e=>{e.target===e.currentTarget&&o()},children:t.jsxs("div",{className:"tut-modal",role:"dialog","aria-modal":"true",children:[t.jsxs("div",{className:"tut-modal-cab",children:[t.jsx("h2",{children:"Agregar tutorado"}),t.jsx("button",{type:"button",className:"tut-x",onClick:o,"aria-label":"Cerrar",children:"×"})]}),t.jsx("p",{className:"tut-hint",children:"Busca al alumno por su correo o su teléfono (coincidencia exacta). Si no tiene cuenta, el administrador debe vincularlo."}),t.jsxs("form",{className:"tut-buscar",onSubmit:y,children:[t.jsxs("label",{children:[t.jsx("span",{children:"Correo"}),t.jsx("input",{value:n,onChange:e=>l(e.target.value),placeholder:"alumno@correo.com",autoFocus:!0})]}),t.jsxs("label",{children:[t.jsx("span",{children:"Teléfono (10 dígitos)"}),t.jsx("input",{value:s,onChange:e=>N(e.target.value),placeholder:"2221234567",inputMode:"numeric"})]}),t.jsx("button",{type:"submit",className:"tut-btn",disabled:h,children:h?"Buscando…":"Buscar"})]}),b&&t.jsx("div",{className:"tut-alerta tut-alerta-error",children:b}),u&&t.jsx("div",{className:"tut-alerta tut-alerta-ok",children:u}),f&&t.jsx("div",{className:"tut-resultados",children:f.length===0?t.jsx("p",{className:"tut-hint",children:"Ningún alumno coincide exactamente. Verifica el dato."}):f.map(e=>t.jsxs("div",{className:"tut-resultado",children:[t.jsxs("div",{children:[t.jsxs("div",{className:"tut-card-nombre",children:[e.nombre," ",e.apellidos]}),t.jsxs("div",{className:"tut-card-meta",children:[S[e.nivel]||e.nivel,!e.tiene_cuenta&&" · sin cuenta"]})]}),e.tiene_cuenta?e.ya_vinculado?t.jsx("span",{className:"tut-nota",children:"Ya vinculado"}):t.jsx("button",{type:"button",className:"tut-btn tut-btn-sm",disabled:j===e.id,onClick:()=>w(e),children:j===e.id?"Solicitando…":"Solicitar vínculo"}):t.jsx("span",{className:"tut-nota",children:"Pídele al administrador que lo vincule"})]},e.id))})]})})}function M(){_();const[o,i]=r.useState(!0),[n,l]=r.useState(null),[s,N]=r.useState([]),[h,g]=r.useState([]),[f,v]=r.useState(null),[b,c]=r.useState(!1);async function j(){const{data:a}=await d.rpc("solicitudes_pendientes_del_tutor");g(a||[])}return r.useEffect(()=>{let a=!1;return(async()=>{const{data:{session:u}}=await d.auth.getSession();if(a)return;if(!u){i(!1);return}const{data:x}=await d.from("profiles").select("*").eq("id",u.user.id).single();if(a)return;v(x);const y=x;if(l(y),y){const{data:w}=await d.from("alumno_tutor").select("alumno_id").eq("tutor_id",x.id).eq("estado","activo"),e=(w||[]).map(p=>p.alumno_id);if(e.length){const{data:p}=await d.from("alumnos").select("*").in("id",e).order("apellidos",{ascending:!0});a||N(p||[])}const{data:m}=await d.rpc("solicitudes_pendientes_del_tutor");a||g(m||[])}i(!1)})(),()=>{a=!0}},[]),t.jsxs("div",{className:"tut-root",children:[t.jsx("style",{children:A}),t.jsx(P,{nombre:f?.nombre}),t.jsx("main",{className:"tut-main",children:o?t.jsx("p",{className:"tut-muted",children:"Cargando…"}):n?t.jsxs(t.Fragment,{children:[t.jsxs("header",{className:"tut-cab",children:[t.jsx("span",{className:"tut-eyebrow",children:"Tutor"}),t.jsxs("h1",{className:"tut-h1",children:[n.nombre," ",n.apellidos]}),t.jsx("p",{className:"tut-sub",children:s.length===0?"Todavía no tienes alumnos vinculados.":`${s.length} ${s.length===1?"alumno":"alumnos"} a tu cargo.`}),t.jsx("div",{className:"tut-cab-acciones",children:t.jsx("button",{type:"button",className:"tut-btn",onClick:()=>c(!0),children:"Agregar tutorado"})})]}),h.length>0&&t.jsxs("section",{className:"tut-pendientes",children:[t.jsx("h2",{className:"tut-h2",children:"Pendientes de confirmación"}),h.map(a=>t.jsxs("div",{className:"tut-pendiente",children:[t.jsx("span",{className:"tut-avatar",children:(a.nombre||"?").slice(0,1).toUpperCase()}),t.jsxs("div",{className:"tut-pendiente-txt",children:[t.jsxs("div",{className:"tut-card-nombre",children:[a.nombre," ",a.apellidos]}),t.jsxs("div",{className:"tut-card-meta",children:[S[a.nivel]||a.nivel," · esperando que confirme"]})]})]},a.alumno_id))]}),t.jsx("h2",{className:"tut-h2",children:"Mis tutorados"}),t.jsx("div",{className:"tut-grid",children:s.map(a=>{const u=E(a.fecha_nacimiento);return t.jsxs(k,{to:`/tutor/alumno/${a.id}`,className:"tut-card",children:[t.jsxs("div",{className:"tut-card-cab",children:[t.jsx("span",{className:"tut-avatar",children:(a.nombre||"?").slice(0,1).toUpperCase()}),t.jsxs("div",{children:[t.jsxs("div",{className:"tut-card-nombre",children:[a.nombre," ",a.apellidos]}),t.jsxs("div",{className:"tut-card-meta",children:[S[a.nivel]||a.nivel,u!=null&&` · ${u} años`]})]})]}),t.jsxs("div",{className:"tut-card-pie",children:[t.jsx("span",{children:a.email||a.telefono||"Sin contacto"}),t.jsx("span",{className:"tut-flecha","aria-hidden":"true",children:"→"})]})]},a.id)})})]}):t.jsxs("div",{className:"tut-vacio",children:[t.jsx("h1",{children:"Tu cuenta aún no está vinculada"}),t.jsxs("p",{children:["Estás dentro como ",t.jsx("strong",{children:f?.rol||"usuario"}),", pero todavía no hay una ficha de tutor asociada a tu cuenta. Pide al administrador que enlace tu registro."]})]})}),b&&t.jsx(T,{onClose:()=>c(!1),onSolicitado:j})]})}const A=`
