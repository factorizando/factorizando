...
export default function QaaAguaSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 280 130" width="100%" style={{ display: "block", maxHeight: 140 }}>
      {/* molécula angular */}
      <circle cx={90} cy={50} r={18} fill={`${a}38`} stroke={a} strokeWidth="2" />
      ...
      <text x={42} y={96} fill={tema.canal(1)} fontSize="7" fontFamily="'Figtree', system-ui, sans-serif">δ⁺</text>
      <text x={130} y={96} fill={tema.canal(1)} fontSize="7" fontFamily="'Figtree', system-ui, sans-serif">δ⁺</text>
      ...
      <circle cx={206} cy={56} r={14} fill={`${a}26`} stroke={a} strokeWidth="1.6" />
