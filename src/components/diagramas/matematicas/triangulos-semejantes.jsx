// Diagrama «triangulos-semejantes» — matematicas.
// Recibe { tema } y pinta con la paleta de la materia; sin estado propio.
// Salió de SlideRenderer.jsx en la fase 2b (docs/PLAN_MIGRACION.md).

import { M } from "../../../data/teoria/shared.jsx";

export default function TriangulosSemejantesSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 510 200" width="100%" style={{ maxHeight: 200, display: "block" }}>
      ...
      <line x1={B[0]} y1={B[1]} x2={C[0]} y2={C[1]} stroke={tema.canal(1)} strokeWidth="2" opacity="0.85"/>
      <line x1={E[0]} y1={E[1]} x2={F[0]} y2={F[1]} stroke={tema.canal(1)} strokeWidth="2" opacity="0.85"/>
      ...
      <path d={tick2Path(B,C)} stroke={tema.canal(1)} strokeWidth="1.5" fill="none" opacity="0.9"/>
      <path d={tick2Path(E,F)} stroke={tema.canal(1)} strokeWidth="1.5" fill="none" opacity="0.9"/>
      ...
      <path d={arcPath(B,A,C,22)} stroke={tema.canal(1)} strokeWidth="1.5" fill="none" opacity="0.8"/>
      <path d={arcPath(E,D,F,16)} stroke={tema.canal(1)} strokeWidth="1.5" fill="none" opacity="0.8"/>
      ...
      <text x={B[0]-14} y={B[1]+4} fill={tema.canal(1)} fontSize="15" fontFamily="Georgia,serif" fontStyle="italic">B</text>
      ...
      <text x={E[0]-14} y={E[1]+4} fill={tema.canal(1)} fontSize="15" fontFamily="Georgia,serif" fontStyle="italic">E</text>
