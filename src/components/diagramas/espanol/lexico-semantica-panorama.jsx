    ...
    <svg viewBox="0 0 520 158" width="100%" style={{ display: "block" }}>
      ...
      {sinItems.map((item, i) => (
        <g key={i}>
          ...
          <text x="78" y={95 + i * 19} fill={tema.sub} fontSize="9" fontFamily="'Figtree', system-ui, sans-serif">{item}</text>
        </g>
      ))}
      ...
      <text x="260" y="148" fill={tema.sub} fontSize="8.5" fontFamily="'Figtree', system-ui, sans-serif" textAnchor="middle">Hiperonimia · Hiponimia · Cohiponimia</text>
    </svg>
  );
}
