...
export default function CelAnimalVegetalSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 290 140" width="100%" style={{ display: "block", maxHeight: 150 }}>
      {/* Animal */}
      <ellipse cx={70} cy={70} rx={56} ry={48} fill={`${a}0d`} stroke={a} strokeWidth="2" />
      <circle cx={68} cy={66} r={18} fill={`${bl}1f`} stroke={bl} strokeWidth="1.8" />
      <circle cx={68} cy={66} r={6} fill={a} opacity="0.5" />
      <ellipse cx={38} cy={96} rx={10} ry={5} fill={`${tema.canal(2)}33`} stroke={tema.canal(2)} strokeWidth="1.3" transform="rotate(-20 38 96)" />
      ...
      <rect x={172} y={32} width={92} height={76} rx={4} fill={`${a}0d`} stroke={a} strokeWidth="1.6" />
      <circle cx={210} cy={64} r={15} fill={`${bl}1f`} stroke={bl} strokeWidth="1.6" />
      <circle cx={210} cy={64} r={5} fill={a} opacity="0.5" />
      {/* cloroplastos */}
      <ellipse cx={244} cy={46} rx={9} ry={4.5} fill={`${tema.canal(1)}4d`} stroke={tema.canal(1)} strokeWidth="1.3" transform="rotate(25 244 46)" />
      <ellipse cx={238} cy={92} rx={9} ry={4.5} fill={`${tema.canal(1)}4d`} stroke={tema.canal(1)} strokeWidth="1.3" transform="rotate(-15 238 92)" />
