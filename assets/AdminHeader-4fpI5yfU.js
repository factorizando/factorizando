import{u as h,j as a,L as s,f as p,r as o}from"./index-Bd36RRGt.js";const x=[{id:"alumnos",label:"Alumnos"},{id:"solicitudes",label:"Solicitudes"},{id:"tutores",label:"Tutores"},{id:"cuestionarios",label:"Estadísticas"},{id:"presentaciones",label:"Presentaciones"},{id:"cursos",label:"Cursos"},{id:"inscripciones",label:"Inscripciones"},{id:"cargos",label:"Cargos"},{id:"suscripciones",label:"Suscripciones"},{id:"regularizacion",label:"Regularización",to:"/regularizacion"}];function g(){const r=p(),n=o.useRef(null);return o.useEffect(()=>{if(r&&window.katex&&n.current)try{window.katex.render("\\mathbb{R}[i]",n.current,{throwOnError:!1,displayMode:!1})}catch{}},[r]),a.jsxs("span",{className:"ah-brand-name",children:["Facto",a.jsx("span",{className:"ah-brand-math",ref:n,children:"ℝ[i]"}),"zando"]})}function u({active:r,onChange:n,tabs:t,chip:l="Panel Admin"}){const i=h(),c=t||x;function d(e){e.to?i(e.to):n?n(e.id):i("/admin")}return a.jsxs("header",{className:"ah-top",children:[a.jsx("style",{children:f}),a.jsxs("div",{className:"ah-brand",children:[a.jsx(s,{to:"/",className:"ah-logo-link",title:"Inicio",children:a.jsx("span",{className:"ah-logo-ring",children:a.jsx("img",{src:"/factorizando/assets/marca/v-avatar.svg",alt:"Factorizando"})})}),a.jsx(g,{}),a.jsx("span",{className:"ah-sep",children:"|"}),a.jsx("span",{className:"ah-chip",children:l})]}),a.jsx("nav",{className:"ahn-nav",children:c.map(e=>a.jsx("button",{type:"button",className:`ahn-btn ${r===e.id?"ahn-active":""}`,onClick:()=>d(e),children:e.label},e.id))}),a.jsx("div",{className:"ah-cuenta",children:a.jsx(s,{to:"/",className:"ah-ghost",children:"← Inicio"})})]})}const f=`
