...
export default function QaaPhSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 290 110" width="100%" style={{ display: "block", maxHeight: 120 }}>
      ...
      <text x={50} y={66} textAnchor="middle" fill="#f87171" fontSize="9" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700">ÁCIDO</text>
      <text x={50} y={78} textAnchor="middle" fill={mu} fontSize="6.5" fontFamily="'Figtree', system-ui, sans-serif">pH &lt; 7 · H⁺</text>
      <text x={155} y={66} textAnchor="middle" fill="#4ade80" fontSize="9" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700">NEUTRO 7</text>
      <text x={245} y={66} textAnchor="middle" fill="#60a5fa" fontSize="9" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="700">BÁSICO</text>
