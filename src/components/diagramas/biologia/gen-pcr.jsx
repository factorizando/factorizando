...
export default function GenPcrSVG({ tema }) {
  ...
  return (
    <svg viewBox="0 0 290 130" width="100%" style={{ display: "block", maxHeight: 140 }}>
      ...
      <text x={48} y={28} textAnchor="middle" fill={ro} fontSize="7" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="600">1. desnaturaliza</text>
      <line x1={26} y1={36} x2={70} y2={36} stroke={bl} strokeWidth="2.4" />
      <line x1={26} y1={58} x2={70} y2={58} stroke={a} strokeWidth="2.4" />
      <text x={48} y={74} textAnchor="middle" fill={mu} fontSize="6" fontFamily="'Figtree', system-ui, sans-serif">calor separa</text>
      {/* paso 2: hibridación */}
      <text x={145} y={28} textAnchor="middle" fill={bl} fontSize="7" fontFamily="'Figtree', system-ui, sans-serif" fontWeight="600">2. hibrida</text>
      ...
      <text x={145} y={74} textAnchor="middle" fill={mu} fontSize="6" fontFamily="'Figtree', system-ui, sans-serif">cebadores</text>
      {/* paso 3: extensión */}
      ...
      {/* crecimiento 2^n */}
      <text x={145} y={104} textAnchor="middle" fill={T} fontSize="8" fontFamily="'Figtree', system-ui, sans-serif">1 → 2 → 4 → 8 → … = 2ⁿ copias</text>
      <text x={145} y={120} textAnchor="middle" fill={mu} fontSize="6.6" fontFamily="'Figtree', system-ui, sans-serif">sin vector viral ni bacteriano: todo ocurre en un tubo</text>
    </svg>
  );
}
