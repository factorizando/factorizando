...
export const PRESENTACION = {
  ...
  slides: [
    ...
    // Ejemplo · Temperatura y calor
    {
      ...
      enunciado: "Pones una cuchara metálica fría dentro de una taza de café caliente. ¿En qué dirección fluye el calor y qué ocurre con las temperaturas?",
      math: "\\text{caliente} \\to \\text{frío}",
      por_que: "El calor siempre fluye del cuerpo de mayor temperatura (el café) al de menor (la cuchara). El café se enfría un poco y la cuchara se calienta, hasta que ambos llegan a la misma temperatura: el equilibrio térmico.",
    ...
    // Ejemplo · Leyes de la termodinámica
    {
      ...
      enunciado: "A un gas se le suministran 500 J de calor y, al expandirse, realiza 200 J de trabajo sobre el exterior. ¿Cuánto cambia su energía interna?",
      math: "\\Delta U = Q - W",
      por_que: "Por la primera ley (conservación de la energía), la energía interna aumenta con el calor que entra y disminuye con el trabajo que el gas realiza. Se restan ambas cantidades.",
    ...
    // Ejemplo · Transferencia de calor
    {
      ...
      svgDiagram: "ter-transferencia",
      enunciado: "Acercas la mano a una fogata, sin tocarla y sin estar sobre el aire caliente que sube, y sientes el calor. ¿Por qué mecanismo te llega?",
      math: "\\text{conducción · convección · radiación}",
      por_que: "El calor que sientes sin contacto y sin un fluido que lo transporte llega por radiación: ondas electromagnéticas (infrarrojas) que viajan sin necesitar un medio material.",
