import{u as y,a as j,r as o,s,j as r}from"./index-CRxS88FY.js";function k(){return r.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","aria-hidden":"true",children:[r.jsx("circle",{cx:"12",cy:"12",r:"9",strokeWidth:"1.7"}),r.jsx("path",{strokeLinecap:"round",strokeWidth:"1.7",d:"M12 7.5v5l3 1.8"})]})}function N(){const a=y();j();const[m,v]=o.useState(!0),[x,g]=o.useState(null),[c,p]=o.useState(null),[d,l]=o.useState(!1),[u,f]=o.useState("");o.useEffect(()=>{let i=!1;return(async()=>{const{data:{session:n}}=await s.auth.getSession();if(i)return;if(!n){a("/login?dest=cuenta-pendiente",{replace:!0});return}g(n.user.id);const{data:e}=await s.from("profiles").select("*").eq("id",n.user.id).single();if(!i){if(e&&!e.perfil_completo){a("/completar-perfil",{replace:!0});return}if(e?.rol==="admin"){a("/admin",{replace:!0});return}if(e?.estado_acceso==="aprobado"&&e?.suspendido_en&&(!e.suspendido_hasta||new Date(e.suspendido_hasta)>new Date)){a("/cuenta-suspendida",{replace:!0});return}if(e?.estado_acceso==="aprobado"){a(e.rol==="tutor"?"/tutor":`/${e.bloque||""}`,{replace:!0});return}p(e||{}),v(!1)}})(),()=>{i=!0}},[a]);async function h(){if(!x||d)return;l(!0),f("");const{error:i}=await s.from("profiles").update({estado_acceso:"pendiente",motivo_rechazo:null,revisado_en:null}).eq("id",x);if(l(!1),i){f("No se pudo reenviar la solicitud. Intenta de nuevo.");return}p(n=>({...n,estado_acceso:"pendiente",motivo_rechazo:null}))}async function b(){await s.auth.signOut(),a("/login",{replace:!0})}const t=c?.estado_acceso==="rechazado";return r.jsxs("div",{className:"cpx-root",children:[r.jsx("style",{children:w}),r.jsx("div",{className:"cpx-card",children:m?r.jsxs("div",{className:"cpx-loading",children:[r.jsx("span",{className:"cpx-spinner"})," Cargando…"]}):r.jsxs(r.Fragment,{children:[r.jsx("span",{className:`cpx-icono${t?" cpx-icono-rechazo":""}`,children:r.jsx(k,{})}),r.jsx("h1",{className:"cpx-titulo",children:t?"Tu solicitud no fue aprobada":"Tu cuenta está en revisión"}),r.jsx("p",{className:"cpx-texto",children:t?"Un administrador revisó tu registro y de momento no otorgó acceso. Puedes corregir tus datos y volver a enviar la solicitud.":"Registramos tu solicitud y un administrador la revisará pronto. En cuanto la apruebe, podrás entrar al bloque que te asigne."}),t&&c?.motivo_rechazo&&r.jsxs("div",{className:"cpx-motivo",children:[r.jsx("span",{className:"cpx-motivo-tit",children:"Motivo"}),r.jsx("p",{children:c.motivo_rechazo})]}),u&&r.jsx("div",{className:"cpx-error",children:u}),r.jsxs("div",{className:"cpx-acciones",children:[t&&r.jsxs(r.Fragment,{children:[r.jsx("button",{type:"button",className:"cpx-btn-primario",onClick:h,disabled:d,children:d?"Enviando…":"Volver a solicitar"}),r.jsx("button",{type:"button",className:"cpx-btn-secundario",onClick:()=>a("/completar-perfil"),children:"Corregir mis datos"})]}),r.jsx("button",{type:"button",className:"cpx-btn-secundario",onClick:b,children:"Cerrar sesión"})]})]})})]})}const w=`
